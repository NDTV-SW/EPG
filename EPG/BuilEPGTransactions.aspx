<%@ Page Title="Buil EPG Transactions" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    EnableViewState="true" AutoEventWireup="false" CodeBehind="BuilEPGTransactions.aspx.vb"
    Inherits="EPG.BuilEPGTransactions" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:CheckBox ID="chkDTH" runat="server" CssClass="form-control" />
                                    <span class="input-group-addon">
                                    </span>
                                </div>
                            </div>
