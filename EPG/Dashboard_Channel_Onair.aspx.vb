...
Public Class Dashboard_Channel_Onair
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Logger.LogError("DashBoard_Channel_Onair", "Page_Load", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub grdDashBoard_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdDashBoard.RowDataBound
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                'Dim hyXMLMailTill As HyperLink = DirectCast(e.Row.FindControl("hyXMLMailTill"), HyperLink)
                Dim lbChannelname As HyperLink = DirectCast(e.Row.FindControl("lbChannelname"), HyperLink)

                If hyXML.NavigateUrl = "" Then
                    hyXML.Visible = False
                    'hyXMLMailTill.Visible = False
                Else
                    hyXML.NavigateUrl = "~/xml/" & hyXML.NavigateUrl
                    'hyXMLMailTill.NavigateUrl = "javascript:openWin('"&  &"','')"
                End If
            ...
            End If
        Catch ex As Exception
            Logger.LogError("DashBoard_Channel_Onair", "grdDashBoard_RowDataBound", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
