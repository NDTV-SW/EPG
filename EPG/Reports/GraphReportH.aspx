<%@ Page Title="Graphical Reports" Language="vb" MasterPageFile="~/SiteBootStrap.Master" AutoEventWireup="false"
    CodeBehind="GraphReportH.aspx.vb" Inherits="EPG.GraphReportH" %>
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-3">
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddlChannel" CssClass="form-control" runat="server" DataTextField="ChannelId"
