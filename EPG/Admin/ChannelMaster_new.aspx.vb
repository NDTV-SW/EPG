...
#End Region
    ...
    Protected Sub btnAllPublicChannels_Click(sender As Object, e As EventArgs) Handles btnAllPublicChannels.Click
        Dim obj As New clsExecute
        Dim dt As DataTable = obj.executeSQL("rptChannels", "search~allPublic", "VarChar~bit", "~True", True, False)
        Session("dtGrid") = dt
        grdChannelmaster.DataSource = dt
        grdChannelmaster.DataBind()
    End Sub
