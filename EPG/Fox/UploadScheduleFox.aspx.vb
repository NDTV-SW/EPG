...
Public Class UploadScheduleFox
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", "Page Load", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        If txtShelf.Text = "" Then
            myErrorBox("Please select Shelf first !")
            Exit Sub
        End If
        Try
            ...
            obj1.DeleteEPGData(txtShelf.Text)
            ...
            If excelReader.AsDataSet.Tables(0).Rows.Count > 0 Then
                If excelReader.AsDataSet.Tables(0).Rows.Count > 7 Then
                    ...
                    For i = 7 To excelReader.AsDataSet.Tables(0).Rows.Count - 1
                        If IsDBNull(excelReader.AsDataSet.Tables(0).Rows(i).Item(1)) Then
                            Exit For
                        End If

                        If i = 21 Then
                            Logger.LogError("Upload Schedule4WOI", "btnUpload_Click", "1", User.Identity.Name)
                        End If

                        Dim obj As New ImportExcel
                        Dim objMethod As New ImportExcelMethod
                        obj.Shelf_Name = excelReader.AsDataSet.Tables(0).Rows(i).Item(1)
                        obj.Shelf_Title = excelReader.AsDataSet.Tables(0).Rows(i).Item(2)

                        If IsDBNull(excelReader.AsDataSet.Tables(0).Rows(i).Item(3)) Then
                            obj.Shelf_Prod_Year = -1
                        ElseIf excelReader.AsDataSet.Tables(0).Rows(i).Item(3) > 2000 And excelReader.AsDataSet.Tables(0).Rows(i).Item(3) < 2100 Then
                            obj.Shelf_Prod_Year = excelReader.AsDataSet.Tables(0).Rows(i).Item(3)
                        Else
                            obj.Shelf_Prod_Year = DateTime.FromOADate(excelReader.AsDataSet.Tables(0).Rows(i).Item(3)).ToString("dd-MMM-yyyy")
                        End If

                        ' '' ''   obj.Shelf_Prod_Year = Convert.ToDateTime((excelReader.AsDataSet.Tables(0).Rows(i).Item(3)).ToString("dd-MMM-yyyy")).Date
                        If IsDBNull(excelReader.AsDataSet.Tables(0).Rows(i).Item(4)) Then
                            obj.Shelf_SeasonNo = -1
                        ElseIf excelReader.AsDataSet.Tables(0).Rows(i).Item(4) = "-" Or excelReader.AsDataSet.Tables(0).Rows(i).Item(4) = "" Then
                            obj.Shelf_SeasonNo = -1
                        Else
                            obj.Shelf_SeasonNo = excelReader.AsDataSet.Tables(0).Rows(i).Item(4)
                        End If

                        If IsDBNull(excelReader.AsDataSet.Tables(0).Rows(i).Item(5)) Then
                            obj.Shelf_EpisodeNo = -1
                        ElseIf excelReader.AsDataSet.Tables(0).Rows(i).Item(5) = "-" Or excelReader.AsDataSet.Tables(0).Rows(i).Item(5) = "" Then

                            obj.Shelf_EpisodeNo = -1
                        Else
                            obj.Shelf_EpisodeNo = excelReader.AsDataSet.Tables(0).Rows(i).Item(5)
                        End If

                        If IsDBNull(excelReader.AsDataSet.Tables(0).Rows(i).Item(6)) Then
                            obj.Shelf_Duration = -1
                        ElseIf excelReader.AsDataSet.Tables(0).Rows(i).Item(6) = "-" Or excelReader.AsDataSet.Tables(0).Rows(i).Item(6) = "" Then

                            obj.Shelf_Duration = -1
                        Else
                            obj.Shelf_Duration = excelReader.AsDataSet.Tables(0).Rows(i).Item(6)
                        End If
                        If IsDBNull(excelReader.AsDataSet.Tables(0).Rows(i).Item(7)) Then
                            obj.Shelf_Hours = -1
                        ElseIf excelReader.AsDataSet.Tables(0).Rows(i).Item(7) = "-" Or excelReader.AsDataSet.Tables(0).Rows(i).Item(7) = "" Then

                            obj.Shelf_Hours = -1
                        Else
                            obj.Shelf_Hours = excelReader.AsDataSet.Tables(0).Rows(i).Item(7)
                        End If
                        '''' obj.Shelf_Duration = excelReader.AsDataSet.Tables(0).Rows(i).Item(6)
                        ''''obj.Shelf_Hours = excelReader.AsDataSet.Tables(0).Rows(i).Item(7)
                        obj.Shelf_LP_StartDate = DateTime.FromOADate(excelReader.AsDataSet.Tables(0).Rows(i).Item(8)).ToString("dd-MMM-yyyy")
                        obj.Shelf_LP_EndDate = DateTime.FromOADate(excelReader.AsDataSet.Tables(0).Rows(i).Item(9)).ToString("dd-MMM-yyyy")
                        obj.Shelf_Batch = DateTime.FromOADate(excelReader.AsDataSet.Tables(0).Rows(i).Item(10)).ToString("dd-MMM-yyyy")
                        obj.UpdatedBy = User.Identity.Name
                        obj.UploadedAt = DateTime.Now
                        obj.UploadedBy = User.Identity.Name
                        obj.UpdatedAt = DateTime.Now

                        Dim k = objMethod.save(obj)

                        'If dateFlag = 0 Then
                        '    strFirstDate = Convert.ToDateTime((excelReader.AsDataSet.Tables(0).Rows(i).Item(2)).ToString).Date
                        '    dateFlag = 1
                        'End If
                        'strLastdate = Convert.ToDateTime((excelReader.AsDataSet.Tables(0).Rows(i).Item(2)).ToString).Date

                        ' If Convert.ToDateTime((excelReader.AsDataSet.Tables(0).Rows(i).Item(2)).ToString).Date >= DateTime.Now.Date.Date Then
                        ...
                        ' Dim vChannelID As String = txtShelf.Text
                        'Dim vGenre As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(1).ToString
                        'Dim vDate As String = Convert.ToDateTime((excelReader.AsDataSet.Tables(0).Rows(i).Item(2)).ToString).Date
                        'Dim vTime As String = Convert.ToDateTime((excelReader.AsDataSet.Tables(0).Rows(i).Item(3)).ToString).ToShortTimeString
                        'Dim vDuration As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(4).ToString
                        'Dim vDescription As String, vShowWiseDesc As String
                        'If chkUploadSynopsis.Checked = True Then
                        '    vDescription = Logger.RemSplCharsEng(excelReader.AsDataSet.Tables(0).Rows(i).Item(5).ToString)
                        '    vShowWiseDesc = excelReader.AsDataSet.Tables(0).Rows(i).Item(7).ToString
                        'Else
                        '    vDescription = ""
                        '    vShowWiseDesc = ""
                        'End If
            ...
            bindAll()
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", "btnUpload_Click", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub grdEpiMissing_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdEpiMissing.RowCommand
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", e.CommandName.ToLower & " grdData_RowCommand", ex.Message.ToString, User.Identity.Name)
    ...
    Private Sub grdData_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdData.RowCommand
        Try
            ...
            ElseIf e.CommandName.ToLower = "updt" Then
                obj1.updateExcelProg(txtShelf.Text, lbExcelProgName.Text, ddlPrograms.SelectedItem.Text)
                grdData.DataBind()
                bindAll()
            ElseIf e.CommandName.ToLower = "updatemovie" Then
                obj1.updateExcelProg(txtShelf.Text, lbExcelProgName.Text, txtSearchMovie.Text)
                grdData.DataBind()
                bindAll()
        ...
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Else
                    ...
                    sqlDSPrograms.SelectCommand = "select progid,progname from mst_program where active=1 and channelid='" & txtShelf.Text & "' and progname like '" & txtProgName.Text.Replace("'", "''") & "%' order by progname"
            ...
            End If
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", "grdData_RowDataBound", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub btnBuildEPG_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuildEPG.Click
        Try
            ...
            Dim boolBuildEPGSuccess As Boolean = obj1.BuildEPG(txtShelf.Text, True, chkTentative.Checked, User.Identity.Name)
            ...
            Dim dt As DataTable = obj1.EPGUploadError(txtShelf.Text)
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", "btnBuildEPG_Click", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub grdGenre_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdGenre.RowCommand
        Try
            ...
            End If
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", "grdGenre_RowCommand", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub grdGenre_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdGenre.RowDataBound
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule4WOI", "grdGenre_RowDataBound", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub

    Protected Sub txtShelf_TextChanged(sender As Object, e As EventArgs) Handles txtShelf.TextChanged
        'btnBuildEPG.Enabled = True
        bindAll()
        'bindEpiMissing()
        btnUpload.Enabled = True
        ...
        If lbIsMovieShelf.Text.ToUpper = "TRUE" Then
    ...
    Private Sub bindgrdExcelData()
        ...
        Dim obj As New clsExecute
        Dim dt As DataTable = obj.executeSQL("select [Program Name], Genre, convert(varchar,[Date],106), convert(varchar,[Time],108), Duration, [Description],[Episode No],[Show-wise Description],channelID from map_EPGExcel where channelID=@ChannelId order by date,time", "ChannelId", "varchar", txtShelf.Text, False, False)
    ...
    Private Sub bindgrdData()
        Dim obj As New clsExecute
        Dim dt As DataTable = obj.executeSQL("sp_epg_validate_progname", "ChannelId", "varchar", txtShelf.Text, True, False)
        grdData.DataSource = dt
        grdData.DataBind()


        Dim dt1 As DataTable = obj.executeSQL("sp_epg_validate_genre", "ChannelId", "varchar", txtShelf.Text, True, False)
    ...
    Private Sub bindAll()
        Dim obj As New clsExecute
        Dim dt As DataTable = obj.executeSQL("select movie_channel,movielangid from mst_channel where ChannelID='" & txtShelf.Text & "'", False)
        If dt.Rows.Count > 0 Then
            lbIsMovieShelf.Text = dt.Rows(0)("movie_channel").ToString
        End If
        bindgrdData()
        bindgrdExcelData()
        bindgrdGenre()
...
System.Web.Services.WebMethod()> _
    Public Shared Function SearchShelf(ByVal prefixText As String, ByVal count As Integer) As List(Of String)
