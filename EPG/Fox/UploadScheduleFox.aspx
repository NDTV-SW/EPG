<%@ Page Title="Upload Schedule #4 WOI" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadScheduleFox.aspx.vb" Inherits="EPG.UploadScheduleFox" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/SampleFoxUpload.JPG" runat="server"
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtShelf" runat="server" CssClass="form-control" AutoPostBack="true" />
                                    <span class="input-group-addon">
                                        <asp:Label ID="lbIsMovieShelf" runat="server" Visible="false" />
                                        <asp:AutoCompleteExtender ID="ACE_txtShelf" runat="server" ServiceMethod="SearchShelf"
                                            MinimumPrefixLength="2" CompletionInterval="100" EnableCaching="false" CompletionSetCount="10"
                                            TargetControlID="txtShelf" FirstRowSelected="true" />
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel-body">
                    <asp:GridView ID="grdBuildEPGError" runat="server" CssClass="table table-responsive"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ShelfId" HeaderText="Shelf" SortExpression="ShelfId" />
    ...
    <asp:SqlDataSource ID="SqlDSgrdData" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="txtShelf" Name="ChannelId" PropertyName="Text"
                Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
