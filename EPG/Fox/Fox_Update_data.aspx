<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
    EnableViewState="true" AutoEventWireup="false" CodeBehind="Fox_Update_data.aspx.vb" Inherits="EPG.Fox_Update_data" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:DropDownList ID="ddlShelfID" runat="server" DataSourceID="SqlDsShelfMaster"
                                        DataTextField="Shelf_Id" DataValueField="ChannelId" AutoPostBack="true" CssClass="form-control" />
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>
                                    Shelf Title</label>
                                <div class="input-group">
                                    <asp:DropDownList ID="ddlShelfTitle" runat="server" CssClass="form-control" DataSourceID="SqlDsMovies"
    ...
    <asp:SqlDataSource ID="SqlDsShelfMaster" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
        SelectCommand="SELECT Shelf_Id FROM Fox_Shelf_MST order by Shelf_Id"></asp:SqlDataSource>
