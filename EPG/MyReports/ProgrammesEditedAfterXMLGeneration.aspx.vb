    ...
    Protected Sub btnGenerateRequest_Click(sender As Object, e As EventArgs) Handles btnGenerateRequest.Click
        ...
        For Each row In grdReport.Rows
            ...
            If chkChecked.Checked Then
                ...
                obj.executeSQL("insert into aud_autogeneratexml(channelid,requestedby,requestedat,xmlgenerated,fresh) values('" & row.Cells(2).Text & "','" & User.Identity.Name & "',dbo.getlocaldate(),'0','0')", False)
