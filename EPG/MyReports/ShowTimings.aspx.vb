...
Public Class ShowTimings
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If rbProgId.Checked Then
            strSql = "select b.ProgId ID,a.ChannelId Channel,b.ProgName Programme,convert(varchar,a.ProgDate,106) Date,convert(varchar,a.ProgTime,108) Time,datename(dw,a.ProgDate) Day,a.episodeno Episode from mst_epg a join mst_program b on a.progid=b.progid "
