<%@ Page Title="Programmes Edited After XMLGeneration" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/SiteEPGBootstrap.Master" CodeBehind="ProgrammesEditedAfterXMLGeneration.aspx.vb"
    Inherits="EPG.ProgrammesEditedAfterXMLGeneration" %>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h3>
                    Programmes Edited After XML Generation</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="sqlDSReport" runat="server" SelectCommand="select *,TotalCount=(select count(1) from v_programseditedafterxmlgeneration)  from v_programseditedafterxmlgeneration order by 1"
                        ConnectionString="<%$ ConnectionStrings:EPGConnectionString1%>" />
                    <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="select *,TotalCount=(select count(1) from v_programseditedafterxmlgeneration)  from v_programseditedafterxmlgeneration order by 1"
                        ConnectionString="<%$ ConnectionStrings:EPGConnectionString1%>" />--%>
                </div>
            </div>
        </div>
