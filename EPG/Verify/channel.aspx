<%@ Page Title="Channel Verify" Language="vb" AutoEventWireup="false" MasterPageFile="~/verify/Siteverify.Master"
    CodeBehind="channel.aspx.vb" Inherits="EPG.verifychannel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Verify Channel</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <asp:SqlDataSource ID="sqlDS" runat="server" SelectCommand="select * from v_verify_channel where case when @verified=1 then @verified else isnull(verified,0) end =@verified and channelid like '%' + @channelid + '%'"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearch" PropertyName="Text" Name="channelid"
