<%@ Page Title="Hindi & English Prime Time Movies" Language="vb" AutoEventWireup="true" MasterPageFile="~/SiteEPGBootstrap.Master"
    CodeBehind="PrimeTimeMovieCMS.aspx.vb" Inherits="EPG.PrimeTimeMovieCMS" %>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <strong>HINDI AND ENGLISH PRIME TIME MOVIES</strong>
            </div>
            <div class="panel-body">
                        ...
                        <div class="col-sm-9 input-group">
                            ...
                            <span class="input-group-addon">
                                <asp:RegularExpressionValidator ID="REVtxtReleaseYear" runat="server" ControlToValidate="txtReleaseYear"
                                    ForeColor="Red" ValidationExpression="^[0-9]+$" Text="* numbers" ValidationGroup="VGMovieLogos" /></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 input-group">
                            ...
                            <asp:SqlDataSource ID="sqlDSLanguage" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                                SelectCommand="select languageid,fullname from mst_language where active=1 and languageid in (1,2)" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            <small>Ureqa Rating</small></label>
                        <div class="col-sm-9 input-group">
                            <asp:TextBox ID="txtUreqaRating" runat="server" CssClass="form-control" placeholder="1-10 upto 2 decimals" ValidationGroup="VGMovieLogos" />
                            <span class="input-group-addon">
                                <asp:RegularExpressionValidator ID="REVtxtUreqaRating" runat="server"  ValidationGroup="VGMovieLogos" Text="*" ForeColor="Red"
                                    ControlToValidate="txtUreqaRating" ValidationExpression="^\-?(([1-9]\d?|1\d{1,2})((\.|,)\d{0,2})?|200((\.|,)0{1,2})?)$" />
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-md-2 col-sm-6 col-xs-6">
                            ...
                            <asp:SqlDataSource ID="SqlmstLanguage" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                                SelectCommand="select 0 LanguageID,'Select All' FullName, 0 p union select LanguageID,FullName, 1 p from mst_language where active=1 and languageid in (1,2) order by p">
                            </asp:SqlDataSource>
                        </div>
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                    <asp:CheckBox ID="chkusefilters" runat="server" Text="Use Filters" Checked="True" BackColor="Yellow" />
                                </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-3">
                                    <asp:CheckBox ID="chkImageSynopsisCast" runat="server" Text="Image/Synopsis/ Cast Missing" Checked="True" BackColor="Yellow" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                            <asp:CheckBox ID="chkpublicChannels" runat="server" Text="On Ureqa" Checked="False" />
                ...
                <div class="panel-body" style="max-height: 1800px; overflow-y: scroll;">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:GridView ID="grdMovieLogos" runat="server" BackColor="White"
                            ...
                            GridLines="Vertical" EmptyDataText="No record Found..." AllowSorting="true" OnSorting="SortRecords">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Ureqa/TMDB Rating" SortExpression="ureqarating">
                                    <ItemTemplate>
                                        <asp:Label ID="lbureqarating" runat="server" Text='<%#Eval("ureqarating") %>' CssClass="btn-info" /> / <asp:Label ID="lbtmdbrating" runat="server" Text='<%#Eval("tmdbrating") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
