<%@ Page Title="TV Star Dashboard" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label>
                                Search TV Star</label>
                            <div class="input-group">
                                <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Leave blank for All" />
                            </div>
                        </div>
                    </div>
