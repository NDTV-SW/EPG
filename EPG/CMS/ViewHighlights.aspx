<%@ Page Title="View Highlights" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
    CodeBehind="ViewHighlights.aspx.vb" Inherits="EPG.ViewHighlights" %>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h3>
                    View Highlights <span class="pull-right">
                        <asp:Button ID="btnMail" runat="server" Text="Mail to Spuul" CssClass="btn btn-info" />
                    </span>
                </h3>
            </div>
                    ...
                    <asp:GridView ID="grdHighLights" runat="server" AutoGenerateColumns="False" CssClass="table"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Date Time" SortExpression="istDate">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lbISTDate" Text='<%# Bind("date") %>' />
                                    <asp:Label runat="server" ID="lbISTTime" Text='<%# Bind("time") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
