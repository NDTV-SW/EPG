...
Public Class PrimeTimeMovieCMS
        ...
        Try
            ...
            If btnUpdate.Text = "ADD" Then
                If txtReleaseYear.Text = "" Then
                    ...
                    strValues = txtName.Text & "~" & txtSynopsis.Text & "~" & txtLongSynopsis.Text & "~" & txtStarCast1.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & txtDirector.Text & "~" &
                                            txtWriter.Text & "~" & txtCountry.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & chkIsVerified.Checked & "~" &
                                            ddlGenre1.SelectedValue & "~" & ddlGenre2.SelectedValue & "~" & txtTrivia.Text & "~" & txtAwards.Text & "~" & User.Identity.Name & "~A~" & dbUreqaRating
                ...
                Else
                    ...
                    strValues = txtName.Text & "~" & txtSynopsis.Text & "~" & txtLongSynopsis.Text & "~" & txtStarCast1.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & txtReleaseYear.Text & "~" & txtDirector.Text & "~" &
                                            txtWriter.Text & "~" & txtCountry.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & chkIsVerified.Checked & "~" &
                                            ddlGenre1.SelectedValue & "~" & ddlGenre2.SelectedValue & "~" & txtTrivia.Text & "~" & txtAwards.Text & "~" & User.Identity.Name & "~A~" & dbUreqaRating
                End If
            ...
            Else
                If txtReleaseYear.Text = "" Then
                    ...
                    strValues = lbRowId.Text & "~" & txtName.Text & "~" & txtSynopsis.Text & "~" & txtLongSynopsis.Text & "~" & txtStarCast1.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & txtDirector.Text & "~" &
                                            txtWriter.Text & "~" & txtCountry.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & chkIsVerified.Checked & "~" &
                                            ddlGenre1.SelectedValue & "~" & ddlGenre2.SelectedValue & "~" & txtTrivia.Text & "~" & txtAwards.Text & "~" & User.Identity.Name & "~U~" & dbUreqaRating
                Else
                    ...
                    strValues = lbRowId.Text & "~" & txtName.Text & "~" & txtSynopsis.Text & "~" & txtLongSynopsis.Text & "~" & txtStarCast1.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & txtReleaseYear.Text & "~" & txtDirector.Text & "~" &
                                            txtWriter.Text & "~" & txtCountry.Text & "~" & ddlMovieLanguage.SelectedValue & "~" & chkIsVerified.Checked & "~" &
                                            ddlGenre1.SelectedValue & "~" & ddlGenre2.SelectedValue & "~" & txtTrivia.Text & "~" & txtAwards.Text & "~" & User.Identity.Name & "~U~" & dbUreqaRating
                End If
    ...
    Private Function bindGridView(ByVal ImageSynopsisCastMissing As Boolean) As DataTable
        ...
        Dim dt As DataTable = objCMS.getMovies(chkusefilters.Checked, txtSearch1.Text, ddlLanguage.SelectedValue, chkWithImage.Checked, chkWithSynopsis.Checked, chkWithReleaseYear.Checked, chkWithStarCast.Checked, chkVerified.Checked, chkExact.Checked, chkAwards.Checked, User.Identity.Name, ImageSynopsisCastMissing, chkpublicChannels.Checked)
        Return dt
    End Function
