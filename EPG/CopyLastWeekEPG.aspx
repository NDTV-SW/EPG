                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:Button ID="btnCopy" runat="server" Text="Copy EPG from last week" CssClass="btn btn-success"
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:Button ID="btnExport" runat="server" Text="Export EPG" CssClass="btn btn-info"
                                         ValidationGroup="RFGCopyLastWeekEPG" />
                                    <br />
