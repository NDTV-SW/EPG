...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function hideDivplain() {
            $("#popmeplain").slideUp(200);
            $("#black_overlay").slideUp(200);
        }
        ...
        function clientMessage1() {
            try {
                ...
                $("#" + vControlId).html(fileName);
                $("#" + vimgControlid).attr("src", "../uploads/plain/" + $("#MainContent_jsFileName").val());
                hideDivplain();
            }
            catch (ex) {
                alert(ex);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="panel-body">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtSearch1" runat="server" CssClass="form-control" placeholder="search text required for Select All option" />
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                    <asp:GridView ID="grdProgImage" runat="server" AutoGenerateColumns="False" CssClass="table"
                        OnSorting="SortRecords" AllowPaging="True" AllowSorting="True" CellPadding="4"
                        ForeColor="Black" GridLines="Vertical" PageSize="100" BackColor="White" BorderColor="#DEDFDE"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Image">
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink rel="lightbox" ID="hyLogoplain" runat="server">
                                        <asp:Image runat="server" ID="imglogoplain" AlternateText="NDTV" Width="50px" Height="50px" />
                                    </asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="hyVideo" runat="server" Visible="false" Text="Upload Image" ImageUrl="../images/video.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HyperLink ID="hyPlain" runat="server" Text="Upload Plain" CssClass="btn btn-info" />
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <div id="popmeplain">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-right">
            <button type="button" style="float: right" onclick="hideDivplain();">
                X</button>
            <input type="hidden" id="jsProgIdplain" size="50" runat="server" />
            <input type="hidden" id="jsImageIdplain" />
            <input type="hidden" id="jsVideoIdplain" />
            <input type="hidden" id="jsFileNameplain" size="50" runat="server" />
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <asp:AsyncFileUpload ID="AsyncFileUpload2" runat="server" UploadingBackColor="#82CAFA"
                CompleteBackColor="#FFFFFF" Filter="*.jpg;*.jpeg|Supported Images Types (*.jpg;*.jpeg)"
                OnClientUploadComplete="clientMessage1" OnUploadedComplete="AsyncFileUpload2_UploadedComplete"
                ThrobberID="Image2" ProgressInterval="50" SaveBufferSize="128" Width="200px"
                EnableProgress="OnSubmit, OnPreview" />
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            <span style="color: Red">only .jpg and .jpeg files supported</span>
    ...
    <script type="text/javascript">
        ...
        function showDivPlain(jsImageId, jsProgId, jsFileName, jsVideoId) {
            try {

                $("#jsImageIdplain").val(jsImageId);
                $("#jsVideoIdplain").val(jsVideoId);

                document.getElementById("MainContent_jsFileName").value = jsFileName;
                document.getElementById("MainContent_jsProgId").value = jsProgId;

                $("#popmeplain").delay(200).slideDown(300);
                $("#black_overlay").delay(200).slideDown(200);
            }
            catch (ex) {
                alert(ex.ToString());
