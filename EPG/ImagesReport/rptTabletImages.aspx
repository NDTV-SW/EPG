<%@ Page Title="Tablet Stream Images Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
    CodeBehind="rptTabletImages.aspx.vb" Inherits="EPG.rptTabletImages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h3>
                    Tablet Stream Programme Images Report</h3>
            </div>
    ...
    <asp:SqlDataSource ID="sqlDSImagesReport" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
        SelectCommand="rptTabletImages" SelectCommandType="StoredProcedure">
        <SelectParameters>
