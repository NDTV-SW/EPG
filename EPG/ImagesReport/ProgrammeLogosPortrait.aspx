<%@ Page Title="Portrait Logos" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
    CodeBehind="ProgrammeLogosPortrait.aspx.vb" Inherits="EPG.ProgrammeLogosPortrait" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:SqlDataSource ID="SqlmstChannel" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                                                SelectCommand="SELECT '0' Channelid,'Select All' Channelid1, 0 p union select channelid,channelid,1 p FROM mst_channel where active=1 and onair=1 and sendepg=1 and channelid in ( select channelid from dthcable_channelmapping where operatorid in (214,301,187,222,335) ) order by p,Channelid">
                                            </asp:SqlDataSource>
                                            <span class="input-group-addon"></span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <asp:GridView ID="grdProgImage" runat="server" AutoGenerateColumns="False" CssClass="table"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Logo" SortExpression="programlogoportrait">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbProgLogo" Text='<%# Bind("programlogoportrait") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
