...
Public Class UploadChannelLogos160x90
    ...
    Private Sub uploadFile()
        Try
            ...
            If filename.ToLower.EndsWith(".png") Then
                ...
                Dim strUploadPath As String = "~/uploads/ChannelLogos/160x90/"
    ...
    Private Function getFilePath(ByVal exactPath As Boolean) As String
        ...
        If exactPath Then
            Return Server.MapPath("~/uploads/ChannelLogos/160x90/" & strSanitizedFilename & ".png")
        Else
            Return "~/uploads/ChannelLogos/160x90/" & strSanitizedFilename & ".png"
        End If
    End Function
    ...
    Protected Sub grdChannelLogo_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles grdChannelLogo.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            imglogo.ImageUrl = "~/uploads/ChannelLogos/160x90/" & lbChannelId.Text.Replace(" ", "_") & ".png"
            hylogo.NavigateUrl = "~/uploads/ChannelLogos/160x90/" & lbChannelId.Text.Replace(" ", "_") & ".png"
        End If
