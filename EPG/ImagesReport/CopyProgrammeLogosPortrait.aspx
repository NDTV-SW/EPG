<%@ Page Title="Copy Programme Logos Portrait" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
    CodeBehind="CopyProgrammeLogosPortrait.aspx.vb" Inherits="EPG.CopyProgrammeLogosPortrait" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        function source() {
            ...
            imgSrc.src = "http://epgops.ndtv.com/uploads/portrait/" + strUser;
    ...
    <div class="container">
        <div class="panel panel-danger">
            <div class="panel-heading text-center">
                <h3>Copy Programme Logos Portrait</h3>
            </div>
                            ...
                            <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" CssClass="table" OnSorting="SortRecords"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Logo" SortExpression="programlogoportrait">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbprogramlogoportrait" Text='<%# Bind("programlogoportrait") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
