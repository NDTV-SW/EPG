            ...
            <div class="panel-body">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 input-group">
                            <asp:TextBox ID="txtUreqaRating" runat="server" CssClass="form-control" placeholder="0-10 upto 2 decimals" ValidationGroup="VGMovieLogos" />
                            <span class="input-group-addon">
                                <asp:RegularExpressionValidator ID="REVtxtUreqaRating" runat="server"  ValidationGroup="VGMovieLogos" Text="0-10 upto 2 decimals" ForeColor="Red"
                                    ControlToValidate="txtUreqaRating" ValidationExpression="^\-?(([0-9]\d?|1\d{1,2})((\.|,)\d{0,2})?|200((\.|,)0{1,2})?)$" />
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
                                    <asp:CheckBox ID="chkAwards" runat="server" Text="Award" Checked="False" />
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
                                    <asp:CheckBox ID="chkHTRP" runat="server" Text="HTRP" Checked="False" />
                                </div>
                            </div>
                        </div>
