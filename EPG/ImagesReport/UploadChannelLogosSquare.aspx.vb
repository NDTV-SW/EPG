...
Public Class UploadChannelLogosSquare
    ...
    Private Sub uploadFile()
        Try
            ...
            If filename.ToLower.EndsWith(".png") Then
                ...
                Dim strUploadPath As String = "~/uploads/ChannelLogos/square/"
                ...
                'abc.doS3Task(strUploadPath, "/uploads/Channellogos/160x90")
    ...
    '                imglogo.ImageUrl = "~/uploads/ChannelLogos/" & lbChannelId.Text.Replace(" ", "_") & ".png"
    '                hylogo.NavigateUrl = "~/uploads/ChannelLogos/" & lbChannelId.Text.Replace(" ", "_") & ".png"
    ...
    Private Function getFileName() As String
        Return sanitizeFile(ddlChannelName.SelectedValue.Replace(" ", "_")) & ".png"
    End Function
    Private Function getFilePath(ByVal exactPath As Boolean) As String
        ...
        If exactPath Then
            Return Server.MapPath("~/uploads/ChannelLogos/square/" & strSanitizedFilename & ".png")
        Else
            Return "~/uploads/ChannelLogos/square/" & strSanitizedFilename & ".png"
        End If
    End Function
    ...
    Protected Sub grdChannelLogo_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles grdChannelLogo.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            imglogo.ImageUrl = "~/uploads/ChannelLogos/square/" & lbChannelId.Text.Replace(" ", "_") & ".png"
            hylogo.NavigateUrl = "~/uploads/ChannelLogos/square/" & lbChannelId.Text.Replace(" ", "_") & ".png"
        End If
