...
Public Class rptYuppMovieImages
    ...
    Protected Sub grdGECImagesReport_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdGECImagesReport.RowDataBound
        If e.Row.RowType = DataControlRowType.Header Then
            rowId = 0
            intEPGImages = 0
            intEPGImagesPers = 0
