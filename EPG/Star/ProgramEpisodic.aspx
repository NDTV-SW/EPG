<%@ Page Title="Program Epiodic" Language="vb" MasterPageFile="SiteStar.Master"
    AutoEventWireup="false" CodeBehind="ProgramEpisodic.aspx.vb" Inherits="EPG.ProgramEpisodic"
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <script type="text/javascript">
        ...
        function openWin(progid, langid, controlid, index, episodeNo) {
            window.open("ProgramEpisodicEdit.aspx?progid=" + progid + "&langid=" + langid + "&controlid=" + controlid + "&index=" + index + "&episodeNo=" + episodeNo, "Edit Programme", "width=640,height=480,toolbar=0,left=250,top=100,scrollbars=no,location=0,menubar=0,resizable=no,status=0");
        }
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:SqlDataSource ID="sqlDSProgramCentral" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
        SelectCommand="sp_program_descriptions_edit_v1_episode_star" SelectCommandType="StoredProcedure">
        <SelectParameters>
