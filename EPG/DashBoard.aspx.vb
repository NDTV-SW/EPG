...
Public Class DashBoard
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Logger.LogError("DashBoard", "Page Load", ex.Message.ToString, User.Identity.Name)
        End Try
    ...
    Private Sub grdDashBoard_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdDashBoard.RowDataBound
        Try
            ...
            End If
        Catch ex As Exception
            Logger.LogError("DashBoard", "grdDashBoard_RowDataBound", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
End Class