<%@ Page Language="vb" Title="Edit Programme"  AutoEventWireup="false"  CodeBehind="EditSynopsisCentral.aspx.vb" Inherits="EPG.EditSynopsisCentral" %>
    ...
    <script type="text/javascript">
        function pageLoad() {
            ...
            if (document.getElementById('hfSend').value == "2") {
                ...
                var channelindex = qs["channelindex"];
                var controlid = qs["controlid"];
                var search = qs["search"];
                //var dt = qs["dt"];

                window.opener.location = window.opener.location.href = "SynopsisCentral.aspx?channelindex=" + channelindex + "&search=" + search + "&controlid=" + controlid + "";
                self.close();
                window.close();
