...
Public Class EditProgName1
        ...
        If Page.IsPostBack = False Then
            Try
                ...
                Else
                    ...
                    Dim adpProgSyn As New SqlDataAdapter("select progName,synopsis from mst_programregional where progid='" & lbProgId.Text & "' and LanguageId='" & lbLangId.Text & "'", ConString)
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        Try
            If BtnSubmit.Text = "Insert" Then
                exec_ProcRegional(lbProgId.Text.Trim, txtProgname.Text.Trim, txtSynopsis.Text.Trim, lbLangId.Text.Trim, 0, "A", "")
            ElseIf BtnSubmit.Text = "Update" Then
                exec_ProcRegional(lbProgId.Text.Trim, txtProgname.Text.Trim, txtSynopsis.Text.Trim, lbLangId.Text.Trim, 0, "C", "")
            End If
    ...
    Private Sub exec_ProcRegional(ByVal ProgId As Integer, ByVal ProgName As String, ByVal synopsis As String, ByVal LanguageID As Integer, ByVal ID As Integer, ByVal action As String, ByVal vEpisodeNo As Integer)
        ...
        Catch ex As Exception
            Logger.LogError("EditProgramName1", action & " exec_ProcRegional", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Protected Sub btnSubmitRefresh_Click(sender As Object, e As EventArgs) Handles btnSubmitRefresh.Click
        Try
            If BtnSubmit.Text = "Insert" Then
                exec_ProcRegional(lbProgId.Text.Trim, txtProgname.Text.Trim, txtSynopsis.Text.Trim, lbLangId.Text.Trim, 0, "A", "")
            ElseIf BtnSubmit.Text = "Update" Then
