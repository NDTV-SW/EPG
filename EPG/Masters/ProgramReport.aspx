<%@ Page Title="New Programs Added" Language="vb" MasterPageFile="~/SiteEPGBootstrap.Master"
    AutoEventWireup="false" CodeBehind="ProgramReport.aspx.vb" Inherits="EPG.ProgramReport" %>
    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12 text-right">
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12">
                        <asp:DropDownList ID="ddlLanguage" runat="server" DataSourceID="sqlDSLanguage" CssClass="form-control"
                        ...
                        <asp:SqlDataSource ID="sqlDSLanguage" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                             SelectCommand="select LanguageID,FullName from mst_language order by 2" />
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                        <asp:DropDownList ID="ddlChannelGenre" runat="server" CssClass="form-control" DataSourceID="sqlDSChannelGenre" DataTextField="GenreName" DataValueField="GenreId" />
                        <asp:SqlDataSource ID="sqlDSChannelGenre" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                             SelectCommand="select genreid,genrename from mst_genre where genrecategory='S' order by 2" />
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12 text-right">
                       <strong> Added After</strong>
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12 text-right">
                        <asp:TextBox ID="txtAddedAfterDate" runat="server" CssClass="form-control" placeholder="Added After" ValidationGroup="vgSearch" />
                        <asp:CalendarExtender ID="CE_txtAddedAfterDate" runat="server" TargetControlID="txtAddedAfterDate"
                            PopupButtonID="txtAddedAfterDate" />
                        <asp:RequiredFieldValidator ID="RFV_txtAddedAfterDate" runat="server"
                            ControlToValidate="txtAddedAfterDate" Text="Required" ForeColor="Red" ValidationGroup="vgSearch" />
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12">
                        <asp:Button ID="btnSearch" Text="Search" runat="server" CssClass="btn btn-info" ValidationGroup="vgSearch" />
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:GridView ID="grdProgrammaster1" AutoGenerateColumns="False" runat="server" CssClass="table"
                         OnSorting="SortRecords" AllowSorting="True" AllowPaging="True" PageSize="20" BackColor="White" BorderColor="#DEDFDE"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SubGenre" SortExpression="SubGenreName" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lbSubGenreId" runat="server" Text='<%# Bind("SubGenreId") %>' Visible="False" />
                            ...
                            <asp:TemplateField HeaderText="Catchup" SortExpression="CatchupFlag">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="AirTime" SortExpression="showairtime">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Channel TRP" SortExpression="trp">
                                <ItemTemplate>
                                    <asp:Label ID="lbChannelTRP" runat="server" Text='<%# Bind("trp") %>' Visible="true" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Program TRP" SortExpression="programtrp">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Added On" SortExpression="program_added_timestamp">
                                <ItemTemplate>
                                    <asp:Label ID="lbAddedon" runat="server" Text='<%# Bind("program_added_timestamp") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
