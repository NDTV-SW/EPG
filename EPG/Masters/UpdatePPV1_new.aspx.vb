...
Public Class UpdatePPV1_new
    ...
    Protected Sub ddlChannelID_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlChannelID.SelectedIndexChanged
        Try
    ...
    Private Sub CreateXml()
        ...
        strSql.Append("select dbo.fn_xml_main_ppv_new('" & ChannelId & "','" & StartDate.ToString("MM/dd/yyyy") & "','" & EndDate.ToString("MM/dd/yyyy") & "')")
