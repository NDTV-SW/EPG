<%@ Page Language="vb" Title="Edit Programme"  AutoEventWireup="false"  CodeBehind="EditProgNameSearch.aspx.vb" Inherits="EPG.EditProgNameSearch" %>
    ...
    <script type="text/javascript">
        function pageLoad() {
            ...
            if (document.getElementById('hfSend').value == "2") {
                ...
                window.opener.location = window.opener.location.href = "ProgramCentralEditAll.aspx?ChannelId=" + ChannelId + "&search=" + search + "&controlid=" + controlid + "&exact=" + exact + "";
                self.close();
                window.close();
        ...
        <tr>
         ...
         <tr>
            <td colspan="5" align="center">
                ...
                <asp:Label ID="lbexact" runat="server" Visible="False" />
