        ...
        Try
            Select Case e.Row.RowType
                ...
                Case DataControlRowType.DataRow
                    ...
                    hyTamEdit.NavigateUrl = "javascript:openWin('" & ddlChannelOnair1.SelectedValue & "','" & lbProgId.Text.Trim & "','" & lbTamLangId.Text & "','MainContent_grdProgramCentral_hyTamEdit_" & e.Row.RowIndex & "','" & txtChannel.Text & "','" & lbEpisodeNo.Text.Trim & "')"
                    hyMarEdit.NavigateUrl = "javascript:openWin('" & ddlChannelOnair1.SelectedValue & "','" & lbProgId.Text.Trim & "','" & lbMarLangId.Text & "','MainContent_grdProgramCentral_hyMarEdit_" & e.Row.RowIndex & "','" & txtChannel.Text & "','" & lbEpisodeNo.Text.Trim & "')"
                    hyTelEdit.NavigateUrl = "javascript:openWin('" & ddlChannelOnair1.SelectedValue & "','" & lbProgId.Text.Trim & "','" & lbTelLangId.Text & "','MainContent_grdProgramCentral_hyTelEdit_" & e.Row.RowIndex & "','" & txtChannel.Text & "','" & lbEpisodeNo.Text.Trim & "')"
