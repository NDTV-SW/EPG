...
Public Class EditProgName7
    ...
    Private Sub exec_Proc(ByVal ProgId As Integer, ByVal ProgName As String, ByVal action As String)
        Try
            obj.executeSQL("sp_mst_program", "progid~progName~Action~ActionUser", "Int~nVarChar~Char~VarChar", ProgId & "~" & Logger.RemSplCharsEng(ProgName.ToString.Trim) & "~" & action & "~" & User.Identity.Name, True, False)
        Catch ex As Exception
