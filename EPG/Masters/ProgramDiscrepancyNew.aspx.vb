            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Else
                    ...
                    ElseIf txtProgramname.Text = "N" And txtSynopsis.Text = "Y" Then
                        ...
                        If lbOrigProgName.Text.Trim = "" Then
                            btn.Text = "Insert"
                            btn.CommandName = "insert"
                        Else
                            btn.Text = "Update"
    ...
    Private Sub exec_ProcRegional(ByVal ProgId As Integer, ByVal ProgName As String, ByVal synopsis As String, ByVal LanguageID As Integer, ByVal ID As Integer, ByVal action As Char, ByVal vEpisodeNo As Integer)
        Try
            ...
            If Not (action.ToString.ToUpper = "A" And vProgName.Trim = "") Then
                ...
                Dim obj As New clsExecute
                Dim dt As DataTable = obj.executeSQL("select * from mst_programregional where progid='" & ProgId & "' and languageid='" & LanguageID & "' and episodeno='" & vEpisodeNo & "'", False)
...
System.Web.Services.WebMethod()> _
    Public Shared Function SearchChannel(ByVal prefixText As String, ByVal count As Integer) As List(Of String)
        ...
        Dim channels As List(Of String) = obj.getChannelsForXMLAirtel(prefixText, count)
        Return channels
    End Function
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        For Each row In grdProgrammaster.Rows
            ...
            If chkCopyEnglish.Checked Then
                ...
                Dim obj As New clsExecute
                Dim dt As DataTable = obj.executeSQL("select * from mst_programregional where progid='" & lbProgID.Text & "' and episodeno=0 and languageid='" & lbLanguageid.Text & "'", False)
                If dt.Rows.Count = 1 Then
                    exec_ProcRegional(lbProgID.Text, dt.Rows(0)("progname").ToString, dt.Rows(0)("synopsis").ToString, lbLanguageid.Text, 0, "A", lbEpisodeNo.Text)
        ...
        bindGrdProgramMaster(False)
    End Sub
    Protected Sub btnCopyEnglish_Click(sender As Object, e As EventArgs) Handles btnCopyEnglish.Click
        Dim row As GridViewRow
        For Each row In grdProgrammaster.Rows
            Dim chkCopyEnglish As CheckBox = DirectCast(row.FindControl("chkCopyEnglish"), CheckBox)
            If chkCopyEnglish.Checked Then
                ...
                exec_ProcRegional(lbProgID.Text, lbProgName.Text, lbProgName.Text, lbLanguageid.Text, 0, "A", lbEpisodeNo.Text)
                chkCopyEnglish.Checked = False
        ...
        For Each row In grdProgrammaster.Rows
            ...
            If chkCheckAll.Checked Then
                If Not (lbLanguageid.Text = 1 Or lbLanguageid.Text = 2) Then
                    'If Not (lbLanguageid.Text = 1) Then
