<%@ Page Language="vb" Title="Edit Programme" AutoEventWireup="false" MasterPageFile="~/SiteLess.Master"
    CodeBehind="EditProgNameEpisodic7.aspx.vb" Inherits="EPG.EditProgNameEpisodic7" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function winclose(channelid) {
            ...
            window.opener.location = window.opener.location.href = "ProgramCentralEpisodic7.aspx?channelid='" + channelid + "'";
            //window.close()
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server" onload="javascript:pageLoad();">
                ...
                <div class="col-xs-4">
                    <div class="form-group">
                        <label>
                            Tittle</label>
                        <div class="input-group">
                            <asp:TextBox ID="txtTittle" runat="server"  CssClass="form-control" />
    ...
    <script type="text/javascript">
        ...
        if (document.getElementById('MainContent_hfSend').value == "2") {
            ...
            window.opener.location = window.opener.location.href = "ProgramCentralEditEpisodic7.aspx?controlid=" + controlid + "&index=" + index + "";
            self.close();
            window.close();
            if (window.opener && !window.opener.closed) {
            }
