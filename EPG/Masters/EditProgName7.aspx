<%@ Page Language="vb" Title="Edit Programme" AutoEventWireup="false" CodeBehind="EditProgName7.aspx.vb"
    Inherits="EPG.EditProgName7" %>
    ...
    <script type="text/javascript">
        function pageLoad() {
            if (document.getElementById('hfSend').value == "2") {
                ...
                window.opener.location = window.opener.location.href = "ProgramCentralEdit7.aspx?onair=" + onair + "&controlid=" + controlid + "&index=" + index + "";
                self.close();
                window.close();
        ...
        function winclose(channelid) {
            ...
            window.opener.location = window.opener.location.href = "ProgramCentralEdit7.aspx?channelid='" + channelid + "'";
            //window.close()
...
<body onload="javascript:pageLoad();">
    ...
    <div class="page1">
        <div class="header">
            <div class="title">
                <h2>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/epg7.png" Width="180px" />
                    &nbsp;&nbsp;&nbsp;Edit Programme
                </h2>
            </div>
            <div class="clear">
            ...
            <div align="center">
                <table width="99%" class="whitetable" border="1px" cellpadding="2px">
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <asp:TextBox ID="txtSynopsis" Width="300px" Height="80px" TextMode="MultiLine" runat="server"
