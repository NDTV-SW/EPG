<%@ Page Language="vb" Title="Edit Programme" AutoEventWireup="false" CodeBehind="EditProgName.aspx.vb"
    Inherits="EPG.EditProgName" %>
    ...
    <script type="text/javascript">
        function pageLoad() {
            if (document.getElementById('hfSend').value == "2") {
                ...
                window.opener.location = window.opener.location.href = "ProgramCentralEdit.aspx?onair=" + onair + "&controlid=" + controlid + "&index=" + index + "";
                self.close();
                window.close();
