                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <asp:Label ID="lbError1" runat="server" ForeColor="Red" Text="*" />
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="form-control">
                                        ...
                                        <asp:DropDownList ID="ddlMinutes2" runat="server">
                                            <asp:ListItem Value="MM">MM</asp:ListItem>
                                            <asp:ListItem Value="00">00</asp:ListItem>
                                            <asp:ListItem Value="01">01</asp:ListItem>
                                            <asp:ListItem Value="02">02</asp:ListItem>
                                    ...
                                    <span class="input-group-addon">
                                        <asp:Label ID="lbError2" runat="server" ForeColor="Red" Text="*" />
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    <asp:CheckBox ID="chkEpisodicException" runat="server" CssClass="form-control" Text="Episodic Exception" />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <asp:TextBox ID="txtSeason" placeholder="enter season no." CssClass="form-control"
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <asp:CheckBox ID="chkSubtitles" runat="server" />
                                        <span class="input-group-addon"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <asp:TextBox ID="txtReleaseYear" placeholder="enter release year" CssClass="form-control"
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <asp:TextBox ID="txtChainID" placeholder="enter chain id" CssClass="form-control"
                                            runat="server" />
                                        <span class="input-group-addon"></span>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        <asp:DropDownList ID="ddlSearchBy" runat="server" CssClass="form-control">
                            ...
                            <asp:ListItem Text="ProgID" Value="progid" />
                        </asp:DropDownList>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                    ...
                    <asp:GridView ID="grdProgrammaster1" AutoGenerateColumns="False" runat="server" CssClass="table"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Exception" SortExpression="Exception">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkException" runat="server" Checked='<%# Bind("Exception") %>'
                                        Visible="true" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Season" SortExpression="Season">
                                <ItemTemplate>
                                    <asp:Label ID="lbSeason" runat="server" Text='<%# Bind("seasonno") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Subtitles" SortExpression="Subtitles">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSubtitles" runat="server" Checked='<%# Bind("Subtitles") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Release Year" SortExpression="preleaseyear">
                                <ItemTemplate>
                                    <asp:Label ID="lbReleaseYear" runat="server" Text='<%# Bind("preleaseyear") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="Chain ID" SortExpression="abs_chainid">
                                <ItemTemplate>
                                    <asp:Label ID="lbChainId" runat="server" Text='<%# Bind("abs_chainid") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="showairtime" SortExpression="showairtime">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lbshowairtime1" runat="server" Text='<%# Bind("showairtime2") %>'
                                        Visible="false" />
                                    <asp:Label ID="lbshowairtime2" runat="server" Text='<%# Bind("showairtime3") %>'
                                        Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
