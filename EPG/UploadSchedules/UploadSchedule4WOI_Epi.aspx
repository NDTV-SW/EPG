<%@ Page Title="Upload Schedule #4 WOI Epi" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadSchedule4WOI_Epi.aspx.vb" Inherits="EPG.UploadSchedule4WOI_Epi" %>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3>
                        Upload Schedule #4 WOI Episodic</h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/uploadschedule4woi_epi.jpg" runat="server"
