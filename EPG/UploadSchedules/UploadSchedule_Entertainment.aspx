<%@ Page Title="Upload Schedule Entertainment" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadSchedule_Entertainment.aspx.vb" Inherits="EPG.UploadSchedule_Entertainment" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <script type="text/javascript">
        ...
        function BeginProcess(channelid, gridindex) {
            ...
            iframe.src = "ProcessTaskEpi.aspx?gridindex=" + gridindex + "&channelid=" + channelid + "&progname=" + encodeURIComponent(progname) + "&genre=" + genre + "&episode=" + episode + "&rating=" + rating + "&movie=" + movie + "&status=" + status;
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3>
                        Upload Schedule #Entertainment</h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/UploadSchedule_entertainment.jpg"
                            runat="server" CssClass="btn-lg alert-success table" />
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group">
                                <label>
                                    Generic Synopsis?</label>
                                <div class="input-group">
                                    <asp:CheckBox ID="chkGeneric" runat="server" Checked="false" CssClass="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:CheckBox ID="chkIgnoreSpecial" runat="server" Text="Ignore Special" Checked="false" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView ID="grdMissingRichMeta" runat="server" AutoGenerateColumns="False"
                        CssClass="table table-responsive" AllowPaging="True" PageSize="10" CellPadding="4"
                        ForeColor="Black" GridLines="Vertical" DataSourceID="sqlDSRichMeta" BackColor="White"
                        EmptyDataText="---all programs are linked---" EmptyDataRowStyle-CssClass="alert alert-success text-center"
    ...
    <asp:SqlDataSource ID="sqlDSRichMeta" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
        SelectCommand="select distinct a.rowid,b.progid,b.progname,a.Genre,a.Duration from map_epgexcel a join mst_program b on a.[Program Name]=b.ProgName where a.channelid =@channelid and b.ChannelId=@channelid and isnull(b.richmetaid,0)=0 order by b.progname">
        <SelectParameters>
            <asp:ControlParameter ControlID="txtChannel" Name="ChannelId" PropertyName="Text"
                Type="String" />
        </SelectParameters>
