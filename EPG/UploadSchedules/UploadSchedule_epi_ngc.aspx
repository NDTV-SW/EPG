<%@ Page Title="Upload Schedule #1 Epi NGC" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadSchedule_epi_ngc.aspx.vb" Inherits="EPG.UploadSchedule_epi_ngc" %>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3>
                        Upload Schedule #1 Episodic NGC</h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/us_ngc.jpg" runat="server"
