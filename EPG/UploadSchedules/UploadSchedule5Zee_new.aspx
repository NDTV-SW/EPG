<%@ Page Title="Upload Schedule #5 New" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadSchedule5Zee_new.aspx.vb" Inherits="EPG.UploadSchedule5Zee_new" %>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3>
                        Upload Schedule ZEE #5 New
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="btn-lg alert-success">
                            <b>Note :</b> Sample Format of Excel to Upload<br />
                            <span style="color: Red">PROGRAMME ENTRIES SHOULD START FROM 8th ROW.</span>
                        </div>
                        <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/SampleUpload5.JPG" runat="server"
