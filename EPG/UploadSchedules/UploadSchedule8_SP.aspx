<%@ Page Title="Upload Schedule #8 SP" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadSchedule8_SP.aspx.vb" Inherits="EPG.UploadSchedule8_SP" %>
...
<script type="text/javascript">
    ...
    function BeginProcess(channelid, gridindex) {
        ...
        iframe.src = "ProcessTask.aspx?gridindex=" + gridindex + "&channelid=" + channelid + "&progname=" + encodeURIComponent(progname) + "&genre=" + genre + "&episode=" + episode + "&rating=" + rating + "&movie=" + movie + "&status=" + status;
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3>
                        Upload Schedule #8 Swayam Prabha</h3>
                </div>
