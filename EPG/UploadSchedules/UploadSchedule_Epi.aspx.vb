...
Public Class UploadSchedule_Epi
    ...
    Private Sub InsertEPGData(ByVal vChannelName As String, ByVal vProgName As String, ByVal vGenre As String, ByVal vDate As Date, ByVal vtime As Date, ByVal vduration As Integer, ByVal VDescription As String, ByVal vEpisodeNo As String, ByVal vShowWiseDesc As String, ByVal boolInsert As Boolean, ByVal vIgnoreSpecial As Boolean, ByVal vEpisodicTitle As String, ByVal vPG As String, ByVal vLiveRepeat As String)
        ...
        If dt.Rows.Count = 1 Then
            If Not dt.Rows(0)("channel_genre").ToString.ToLower = "sports" Then
                ...
                If Not (vduration = 0) Then
                    strSql = strSql & "insert into map_epgexcel(channelID, [Program Name],Genre,Date,Time,Duration, Description, [Episode No],[Show-wise Description],episodictitle,pg,liverepeat) values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vDate & "','" & vtime & "','" & vduration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "','" & vEpisodicTitle.Replace("'", "''") & "','" & vPG & "','" & vLiveRepeat & "');"
                End If
                'End If
            Else
                strSql = strSql & "insert into map_epgexcel(channelID, [Program Name],Genre,Date,Time,Duration, Description, [Episode No],[Show-wise Description],episodictitle,pg,liverepeat) values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vDate & "','" & vtime & "','" & vduration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "','" & vEpisodicTitle.Replace("'", "''") & "','" & vPG & "','" & vLiveRepeat & "');"
    ...
    Private Sub grdData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdData.RowDataBound
        Try
            ...
            End If
        Catch ex As Exception
            Logger.LogError("Upload_Schedule_EPI", "grdData_RowDataBound-" & txtChannel.Text, ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    vDate = dt.Rows(i)(3).ToString
                    vTime = dt.Rows(i)(4).ToString
                    vDuration = dt.Rows(i)(5).ToString
                    vEpisodeNo = dt.Rows(i)(7).ToString
                    vShowWiseDesc = dt.Rows(i)(8).ToString
                    Try
                        vPG = dt.Rows(i)(9).ToString
                    Catch ex As Exception
                        vPG = ""
                    End Try
                    Try
                        vLiveRepeat = dt.Rows(i)(10).ToString
                    Catch ex As Exception
                        vLiveRepeat = ""
                    End Try
                    ...
                    Else
                        vDescription = dt.Rows(i)(1).ToString & " : " & dt.Rows(i)(6).ToString
                    End If
                    'Else
                    'vDescription = dt.Rows(i)(6).ToString
                    'End If
                    ...
                    If i < dt.Rows.Count - 1 Then
                        Try
                            vNextDate = dt.Rows(i + 1)(3).ToString
                            vNextProgName = dt.Rows(i + 1)(0).ToString
                            vNextDuration = dt.Rows(i + 1)(5).ToString
                    ...
                    If i = dt.Rows.Count - 1 Then
                        ...
                        Try
                            ...
                            InsertEPGData(vChannelID, vProgName, vGenre, vDate, vTime, vDuration, vDescription, vEpisodeNo, vShowWiseDesc, True, chkIgnoreSpecial.Checked, vEpisodicTitle, vPG, vLiveRepeat)
                            bindAll()
                        ...
                        End Try
                    Else
                        InsertEPGData(vChannelID, vProgName, vGenre, vDate, vTime, vDuration, vDescription, vEpisodeNo, vShowWiseDesc, False, chkIgnoreSpecial.Checked, vEpisodicTitle, vPG, vLiveRepeat)
                    End If
