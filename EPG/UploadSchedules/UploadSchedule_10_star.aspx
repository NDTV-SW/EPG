<%@ Page Title="Upload Schedule #10 Star" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    AutoEventWireup="false" CodeBehind="UploadSchedule_10_star.aspx.vb" Inherits="EPG.UploadSchedule_10_star" %>
...
<script type="text/javascript">
    ...
    function BeginProcess(channelid, gridindex) {
        ...
        series = document.getElementById('MainContent_grdData_ddlSeries_' + gridindex).value;
        ...
        //alert("ProcessTask.aspx?gridindex=" + gridindex + "&channelid=" + channelid + "&progname=" + encodeURIComponent(progname) + "&genre=" + genre + "&episode=" + episode + "&rating=" + rating + "&movie=" + movie + "&status=" + status + "&series=" + series);
        iframe.src = "ProcessTask.aspx?gridindex=" + gridindex + "&channelid=" + channelid + "&progname=" + encodeURIComponent(progname) + "&genre=" + genre + "&episode=" + episode + "&rating=" + rating + "&movie=" + movie + "&status=" + status + "&series=" + series;
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/Sampleuploadschedule10.png" runat="server"
