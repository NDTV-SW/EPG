        ...
        <div class="panel panel-default">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <asp:Button ID="btnExport" runat="server" Text="Export" CssClass="btn btn-sm btn-info" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <asp:GridView ID="grdUploaded" runat="server" AllowPaging="True" AllowSorting="True"
                        OnSorting="SortRecords" PageSize="150" CssClass="table table-bordered table-hover">
                        <Columns>
