                    ...
                    If excelReader.AsDataSet.Tables(0).Rows.Count > 0 Then
                        For i = 0 To excelReader.AsDataSet.Tables(0).Rows.Count - 1
                            ...
                            If dtGMTDate.Date >= DateTime.Now.Date Then
                                ...
                                Dim vEpisodeNo As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(13).ToString
                                Dim vShowWiseDesc As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(16).ToString
                                Dim vDescription As String = Logger.RemSplCharsEng(excelReader.AsDataSet.Tables(0).Rows(i).Item(16).ToString)

                                Dim vGenre As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(11).ToString

                                Dim vActor As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(19).ToString
                                Dim vDirector As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(20).ToString
                                Dim vImageUrl As String = excelReader.AsDataSet.Tables(0).Rows(i).Item(22).ToString
