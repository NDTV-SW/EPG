...
Public Class UploadSchedule_10_star
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", "Page Load", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        ...
        Catch ex As Exception
            ...
            Logger.LogError("Upload Schedule New", "btnUpload_Click", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub

    Private Sub InsertEPGData(ByVal vChannelName As String, ByVal vProgName As String, ByVal vGenre As String, ByVal vDate As Date, ByVal vtime As Date, ByVal vduration As Integer, ByVal VDescription As String, ByVal vEpisodeNo As String, ByVal vShowWiseDesc As String, ByVal season As String, ByVal progname As String, ByVal genre As String, ByVal subgenre As String, ByVal pg As String, ByVal serieslink As String, ByVal liverepeat As String, ByVal SportsSeries As String, ByVal matchround As String, ByVal matchsite As String, ByVal teams As String, ByVal seriesandteams As String, ByVal proglang As String, ByVal releaseyear As String, ByVal actor As String, ByVal director As String, ByVal awards As String, ByVal producer As String, ByVal boolInsert As Boolean)
        ...
        If vProgName = "Filler" Then
            VDescription = "Filler Segment."
        End If
        ...
        If vduration > 240 Then
            Do While (vduration > 240)
                ...
                strSql = strSql & "insert into map_epgexcel (channelID, [Program Name],Genre,Date,Time,Duration, Description, [Episode No],[Show-wise Description],season,progname,broadgenre,subgenre,pg,serieslink,liverepeat,SportsSeries,matchround,matchsite,teams,seriesandteams,proglang,releaseyear,actor,director,awards,producer) "
                strSql = strSql & "values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vDate & "','" & vtime.ToLongTimeString & "','" & newDuration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "',"
                strSql = strSql & "'" & season & "','" & progname & "','" & genre & "','" & subgenre & "','" & pg & "','" & serieslink & "','" & liverepeat & "','" & SportsSeries & "','" & matchround & "',"
                strSql = strSql & "'" & matchsite & "','" & teams & "','" & seriesandteams & "','" & proglang & "','" & releaseyear & "','" & actor & "','" & director & "','" & awards & "','" & producer & "');"
            ...
            strSql = strSql & "insert into map_epgexcel (channelID, [Program Name],Genre,Date,Time,Duration, Description, [Episode No],[Show-wise Description],season,progname,broadgenre,subgenre,pg,serieslink,liverepeat,SportsSeries,matchround,matchsite,teams,seriesandteams,proglang,releaseyear,actor,director,awards,producer) "
            strSql = strSql & "values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vDate & "','" & vtime.ToLongTimeString & "','" & vduration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "',"
            strSql = strSql & "'" & season & "','" & progname & "','" & genre & "','" & subgenre & "','" & pg & "','" & serieslink & "','" & liverepeat & "','" & SportsSeries & "','" & matchround & "',"
            strSql = strSql & "'" & matchsite & "','" & teams & "','" & seriesandteams & "','" & proglang & "','" & releaseyear & "','" & actor.Replace("'", "''") & "','" & director.Replace("'", "''") & "','" & awards.Replace("'", "''") & "','" & producer.Replace("'", "''") & "');"

        Else
            strSql = strSql & "insert into map_epgexcel(channelID, [Program Name],Genre,Date,Time,Duration, Description, [Episode No],[Show-wise Description],season,progname,broadgenre,subgenre,pg,serieslink,liverepeat,SportsSeries,matchround,matchsite,teams,seriesandteams,proglang,releaseyear,actor,director,awards,producer) "
            strSql = strSql & "values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vDate & "','" & vtime & "','" & vduration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "',"
            strSql = strSql & "'" & season & "','" & progname & "','" & genre & "','" & subgenre & "','" & pg & "','" & serieslink & "','" & liverepeat & "','" & SportsSeries & "','" & matchround & "',"
            strSql = strSql & "'" & matchsite & "','" & teams & "','" & seriesandteams & "','" & proglang & "','" & releaseyear & "','" & actor.Replace("'", "''") & "','" & director.Replace("'", "''") & "','" & awards.Replace("'", "''") & "','" & producer.Replace("'", "''") & "');"
    ...
    Private Sub grdEpiMissing_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdEpiMissing.RowCommand
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", e.CommandName.ToLower & " grdData_RowCommand", ex.Message.ToString, User.Identity.Name)
    ...
    Private Sub grdData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdData.RowDataBound
        Try
            ...
            End If
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", "grdData_RowDataBound", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub btnBuildEPG_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuildEPG.Click
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", "btnBuildEPG_Click", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub grdGenre_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grdGenre.RowCommand
        Try
            ...
            End If
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", "grdGenre_RowCommand", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub grdGenre_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdGenre.RowDataBound
        ...
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", "grdGenre_RowDataBound", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub bindgrdExcelData()
        ...
        Dim obj As New clsExecute
        Dim dt As DataTable = obj.executeSQL("select [Program Name], Genre, convert(varchar,[Date],106), convert(varchar,[Time],108), Duration, [Description],[Episode No],[Show-wise Description],liverepeat,channelID from map_EPGExcel where channelID=@ChannelId order by date,time", "ChannelId", "varchar", txtChannel.Text, False, False)
    ...
    Private Sub btnUpdateGenre_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdateGenre.Click
        Try
            ...
            bindAll()
        Catch ex As Exception
            Logger.LogError("Upload Schedule 10", "btnUpdateGenre_Click", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub uploadChannelSchedule(ByVal channelid As String, ByVal filePath As String)
        ...
        If dt.Rows.Count > 0 Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                Dim vseason As String, vbroadprogname As String, vbroadgenre As String, vsubgenre As String, vpg As String, vserieslink As String
                Dim vliverepeat As String, vSportsSeries As String, vmatchround As String, vmatchsite As String, vteams As String
                Dim vseriesandteams As String, vproglang As String, vreleaseyear As String, vactor As String, vdirector As String, vawards As String, vproducer As String

                vNextDate = DateTime.Now.ToString("MM/dd/yyyy")
                vChannelID = channelid
                vProgName = dt.Rows(i)(1).ToString.Replace("#", "")
                vGenre = dt.Rows(i)(2).ToString
                vDate = dt.Rows(i)(4).ToString
                vTime = dt.Rows(i)(5).ToString
                vDuration = dt.Rows(i)(6).ToString
                vDescription = dt.Rows(i)(7).ToString
                vEpisodeNo = dt.Rows(i)(8).ToString
                vShowWiseDesc = dt.Rows(i)(11).ToString

                vseason = dt.Rows(i)(9).ToString
                vbroadprogname = dt.Rows(i)(1).ToString
                vbroadgenre = dt.Rows(i)(2).ToString
                vsubgenre = dt.Rows(i)(3).ToString
                vpg = dt.Rows(i)(12).ToString
                vserieslink = dt.Rows(i)(13).ToString
                vliverepeat = dt.Rows(i)(14).ToString
                vSportsSeries = dt.Rows(i)(15).ToString
                vmatchround = dt.Rows(i)(16).ToString
                vmatchsite = dt.Rows(i)(17).ToString
                vteams = dt.Rows(i)(18).ToString
                vseriesandteams = dt.Rows(i)(19).ToString
                vproglang = dt.Rows(i)(20).ToString
                vreleaseyear = dt.Rows(i)(21).ToString
                vactor = dt.Rows(i)(22).ToString
                vdirector = dt.Rows(i)(23).ToString
                vawards = dt.Rows(i)(24).ToString
                vproducer = dt.Rows(i)(25).ToString
                ...
                If i < dt.Rows.Count - 1 Then
                    vNextDate = dt.Rows(i + 1)(4).ToString
                    vNextProgName = dt.Rows(i + 1)(1).ToString
                    vNextDuration = dt.Rows(i + 1)(6).ToString
                    vNextEpisodeNo = dt.Rows(i + 1)(8).ToString
                    If (vDate <> vNextDate) And (vProgName = vNextProgName) And (vEpisodeNo = vNextEpisodeNo) Then
                        If Convert.ToDateTime(vNextDate) > DateTime.Now.AddDays(1).Date Then
                            vDuration = vDuration
                        Else
                ...
                If i = dt.Rows.Count - 1 Then
                    ...
                    Try
                        ...
                        InsertEPGData(vChannelID, vProgName, vGenre, vDate, vTime, vDuration, vDescription, vEpisodeNo, vShowWiseDesc, vseason, vbroadprogname, vbroadgenre, vsubgenre, vpg, vserieslink, vliverepeat, vSportsSeries, vmatchround, vmatchsite, vteams, vseriesandteams, vproglang, vreleaseyear, vactor, vdirector, vawards, vproducer, True)
                    Catch ex As Exception
                        'Logger.mailMessage(strErrorRecepients, "Error in File upload", "File not uploaded, Error Occured in file. <br/> Filename: " & filePath & ".<br/>Error: " & ex.Message.ToString, "", "")
                        'Logger.LogError(ex.Message.ToString)
                    End Try
                Else
                    'If vDate >= DateTime.Now.AddDays(-1).Date Then
                    InsertEPGData(vChannelID, vProgName, vGenre, vDate, vTime, vDuration, vDescription, vEpisodeNo, vShowWiseDesc, vseason, vbroadprogname, vbroadgenre, vsubgenre, vpg, vserieslink, vliverepeat, vSportsSeries, vmatchround, vmatchsite, vteams, vseriesandteams, vproglang, vreleaseyear, vactor, vdirector, vawards, vproducer, False)
                    'End If
                End If
