<%@ Page Title="Upload Schedule #3" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="UploadSchedule3.aspx.vb" Inherits="EPG.UploadSchedule3" %>
   ...
   <asp:Table ID="Table1" runat="server" Width="95%" GridLines="both" BorderWidth="2" CellPadding="5" CellSpacing="0">
      <asp:TableRow>
         <asp:TableCell ColumnSpan="5" HorizontalAlign="Center" >
            <asp:Image ID="imgSampleScedUpload" ImageUrl="~/Images/SampleUpload3.JPG" runat="server" />
            <br />
            <span style="color:green">Sample Format of Excel to Upload</span>
            <br />
            <span style="color:Red">DATE COLUMN MUST BE IN DD/MM/YYYY FORMAT IN FPC EXCEL</span>
            <br />
         </asp:TableCell>
      </asp:TableRow>
      <asp:TableRow>
         ...
         <asp:TableCell HorizontalAlign="Left" Width="25%" >
            <asp:RegularExpressionValidator ID="REVFileUpload1" ControlToValidate="FileUpload1" runat="server" Text="*"  ErrorMessage="Only .xls file Supported !"
               ValidationExpression="^.*\.(xls|XLS)$" ForeColor="Red" ValidationGroup="VGUploadSched" />
            <asp:RequiredFieldValidator ID="RFVFileUpload1" ControlToValidate="FileUpload1" runat="server" Text="*" ErrorMessage="Please select file first !"
               ForeColor="Red" ValidationGroup="VGUploadSched" />
            <asp:FileUpload ID="FileUpload1" runat="server" />
            
         </asp:TableCell>
         <asp:TableCell HorizontalAlign="Left" VerticalAlign="Top" Width="15%">
            <asp:Button ID="btnUpload" runat="server" Text="UPLOAD" UseSubmitBehavior="false" ValidationGroup="VGUploadSched" />
            ...
            <asp:ValidationSummary ID="ValidationSummary" runat="server" ValidationGroup="VGUploadSched" ForeColor="Red" />
		...
		<br />
         ...
         <br />
            ...
            <br />
            <asp:Label ID="lbEPGBuiltMessage" runat="server" ForeColor="Red" Text="EPG Built Successfully" Visible="false" />
         </asp:TableCell></asp:TableRow><asp:TableRow>
            <asp:TableCell ColumnSpan="5"  HorizontalAlign="Center">
                <asp:GridView ID="grdBuildEPGError" runat="server" RowStyle-BackColor="RosyBrown" EmptyDataRowStyle-BackColor="LawnGreen"
                EmptyDataText="No Error found"  AutoGenerateColumns="false">
                <Columns>
         ...
         <asp:TableCell ColumnSpan="5" HorizontalAlign="Center">
            To Update Program Name with new one, simply click update,<br />else select all other fields from dropdowns to Add new Program.
            <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"
               DataSourceID="SqlDSgrdData" CellPadding="4" ForeColor="#333333" GridLines="Vertical" Width="50%">
         ...
         <asp:TableCell ColumnSpan="5" HorizontalAlign="Center">
            <asp:GridView ID="grdGenre" runat="server" AutoGenerateColumns="false"
               DataSourceID="SqlDSgrdGenre" CellPadding="4" ForeColor="#333333" GridLines="Vertical">
               ...
               <Columns>
                  ...
                  <asp:BoundField DataField="MstGenre" HeaderText="MstGenre" SortExpression="MstGenre" Visible="false" />
                  <asp:BoundField DataField="PossibleAction" HeaderText="PossibleAction" SortExpression="PossibleAction" Visible="false"/>
            ...
            <asp:SqlDataSource ID="SqlDSAvailableGenre" runat="server"
               ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>" 
               SelectCommand="select * from dbo.fn_ProgGenre(@channelid) order by 3,2"> 
               <SelectParameters>
                <asp:ControlParameter ControlID="ddlChannelName" Name="ChannelId" PropertyName="SelectedValue" Type="String" />
         ...
         <asp:TableCell ColumnSpan="5" HorizontalAlign="Center">
            <asp:GridView ID="grdExcelData" runat="server" AutoGenerateColumns="true" AllowPaging="true" AllowSorting="true"
               DataSourceID="SqlDSgrdExcelData" CellPadding="4" ForeColor="#333333" GridLines="Vertical" Width="80%" PagerSettings-PageButtonCount="10" PageSize="100">
               <AlternatingRowStyle BackColor="White" />
               <EditRowStyle BackColor="#2461BF" />
               <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
               <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
