...
Public Class UploadSchedule_epi_ngc
    ...
    Private Sub InsertEPGData(ByVal vChannelName As String, ByVal vProgName As String, ByVal vGenre As String, ByVal vSubGenre As String, ByVal vDate As Date, ByVal vtime As Date, ByVal vduration As Integer, ByVal VDescription As String, ByVal vEpisodeNo As String, ByVal vShowWiseDesc As String, ByVal boolInsert As Boolean, ByVal vIgnoreSpecial As Boolean, ByVal vEpisodicTitle As String, ByVal vPG As String, ByVal vLiveRepeat As String)
        ...
        If dt.Rows.Count = 1 Then
            If Not dt.Rows(0)("channel_genre").ToString.ToLower = "sports" Then
                ...
                If Not (vduration = 0) Then
                    strSql = strSql & "insert into map_epgexcel(channelID, [Program Name],broadGenre,subgenre,Date,Time,Duration, Description, [Episode No],broadepisode,[Show-wise Description],episodictitle,pg,liverepeat) values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vSubGenre.ToString.Trim & "','" & vDate & "','" & vtime & "','" & vduration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "','" & vEpisodicTitle.Replace("'", "''") & "','" & vPG & "','" & vLiveRepeat & "');"
                End If
                'End If
            Else
                strSql = strSql & "insert into map_epgexcel(channelID, [Program Name],broadGenre,subgenre,Date,Time,Duration, Description, [Episode No],broadepisode,[Show-wise Description],episodictitle,pg,liverepeat) values('" & vChannelName.ToString.Trim & "','" & vProgName.ToString.Trim.Replace("'", "''") & "','" & vGenre.ToString.Trim & "','" & vSubGenre.ToString.Trim & "','" & vDate & "','" & vtime & "','" & vduration & "','" & VDescription.Replace("'", "''").ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vEpisodeNo.ToString.Trim & "','" & vShowWiseDesc.Replace("'", "''") & "','" & vEpisodicTitle.Replace("'", "''") & "','" & vPG & "','" & vLiveRepeat & "');"
    ...
    Private Sub bindgrdExcelData()
        ...
        Dim obj As New clsExecute
        Dim dt As DataTable = obj.executeSQL("select [Program Name], broadGenre Genre,SubGenre, convert(varchar,[Date],106), convert(varchar,[Time],108), Duration, [Description],[Episode No],EpisodicTitle,PG,LiveRepeat,channelID from map_EPGExcel where channelID=@ChannelId order by date,time", "ChannelId", "varchar", txtChannel.Text, False, False)
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    Dim vShowWiseDesc As String, vEpisodicTitle As String, vPG As String, vLiveRepeat As String
                    vChannelID = channelid
                    vProgName = dt.Rows(i)(0).ToString
                    vEpisodicTitle = dt.Rows(i)(1).ToString
                    ...
                    vShowWiseDesc = dt.Rows(i)(9).ToString
                    Try
                        vPG = dt.Rows(i)(10).ToString
                    Catch ex As Exception
                        vPG = ""
                    End Try
                    Try
                        vLiveRepeat = dt.Rows(i)(11).ToString
                    Catch ex As Exception
                        vLiveRepeat = ""
                    End Try
                    ...
                    Else
                        vDescription = dt.Rows(i)(1).ToString & " : " & dt.Rows(i)(7).ToString
                    End If
                    'Else
                    'vDescription = dt.Rows(i)(6).ToString
                    'End If
                    'If i = 635 Then
                    ...
                    If i = dt.Rows.Count - 1 Then
                        ...
                        Try
                            ...
                            InsertEPGData(vChannelID, vProgName, vGenre, vSubGenre, vDate, vTime, vDuration, vDescription, vEpisodeNo, vShowWiseDesc, True, chkIgnoreSpecial.Checked, vEpisodicTitle, vPG, vLiveRepeat)
                            bindAll()
                            Dim obj As New clsExecute
                            ...
                            End If
                        Catch ex As Exception
                            Logger.LogError("Upload Schedule New EPI", "uploadChannelSchedule", channelid & " || " & filePath & "||" & ex.Message.ToString, User.Identity.Name)
                        End Try
                    Else
                        InsertEPGData(vChannelID, vProgName, vGenre, vSubGenre, vDate, vTime, vDuration, vDescription, vEpisodeNo, vShowWiseDesc, False, chkIgnoreSpecial.Checked, vEpisodicTitle, vPG, vLiveRepeat)
                    End If
