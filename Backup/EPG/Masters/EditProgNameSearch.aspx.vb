...
Public Class EditProgNameSearch
    ...
    Protected Sub BtnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSubmit.Click
        Try
            If BtnSubmit.Text = "Insert" Then
                exec_ProcRegional(lbProgId.Text.Trim, txtProgname.Text.Trim, txtSynopsis.Text.Trim, lbLangId.Text.Trim, 0, "A", lbEpisodeNo.Text)
            ElseIf BtnSubmit.Text = "Update" Then
                exec_ProcRegional(lbProgId.Text.Trim, txtProgname.Text.Trim, txtSynopsis.Text.Trim, lbLangId.Text.Trim, 0, "C", lbEpisodeNo.Text)
            End If
