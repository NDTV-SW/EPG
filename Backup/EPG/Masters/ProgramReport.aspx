        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                        <asp:DropDownList ID="ddlMovieChannel" runat="server" CssClass="form-control">
                            <asp:ListItem Text="Movie Channels" Value="1" />
                            <asp:ListItem Text="Non-Movie Channels" Value="0" />
                        </asp:DropDownList>
