<%@ Page Language="vb" Title="Edit Programme"  AutoEventWireup="false"  CodeBehind="EditJunkData.aspx.vb" Inherits="EPG.EditJunkData" %>
    ...
    <script type="text/javascript">
        function pageLoad() {
            if (document.getElementById('hfSend').value == "2") {
                ...
                window.opener.location = window.opener.location.href = "FixJunkCharacters.aspx?ChannelId=" + ChannelId + "&controlid=" + controlid + "";
                self.close();
                window.close();
...
<body onload="javascript:pageLoad();">
    ...
    <table width="99%" class="whitetable" border="1px" cellpadding="2px">
        ...
        <tr>
                ...
                <td align="center" colspan="2">
                    <asp:TextBox ID="txtSynopsis" runat="server" Width="320px" Height="80px" 
                        TextMode="MultiLine" />
                </td>
