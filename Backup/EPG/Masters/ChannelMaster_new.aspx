<%@ Page Title="Channel Master" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:GridView ID="grdChannelmaster" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Active / SendEPG" SortExpression="Active" ItemStyle-HorizontalAlign="Center" Visible="false">
                                <ItemTemplate>
