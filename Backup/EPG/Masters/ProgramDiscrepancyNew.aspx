        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-left">
                    <asp:Button ID="btnUpdate" runat="server" Text="Copy English" CssClass="btn btn-success" />
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:GridView ID="grdProgrammaster" runat="server" AutoGenerateColumns="False" EmptyDataRowStyle-BackColor="LightGreen"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Copy English">
                                <ItemTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:GridView ID="grdXMLGenerated" runat="server" ShowHeader="False" align="center"
                                        Width="100%" CellPadding="4" EmptyDataRowStyle-BackColor="LightGreen"
                                        EmptyDataText="No Records to display" ForeColor="Black" GridLines="Vertical"
                                        ...
                                        AllowPaging="True" PageSize="7" AutoGenerateColumns="False" BackColor="White"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:GridView ID="grdGenerateAgain" runat="server" ShowHeader="False" align="center"
                                        ...
                                        EmptyDataText="No Records to display" ForeColor="Black" GridLines="Vertical"
                                        AllowSorting="True" SortedAscendingHeaderStyle-CssClass="sortasc-header" SortedDescendingHeaderStyle-CssClass="sortdesc-header"
                                        AllowPaging="True" PageSize="5" AutoGenerateColumns="False" BackColor="White"
                                        BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
                                        <AlternatingRowStyle BackColor="White" />
                                        <EmptyDataRowStyle BackColor="LightGreen"></EmptyDataRowStyle>
                                        <FooterStyle BackColor="#CCCC99" />
