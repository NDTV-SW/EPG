<%@ Page Title="Update PPV" Language="vb" MasterPageFile="~/SiteEPGBootStrap.Master"
    EnableViewState="true" AutoEventWireup="false" CodeBehind="UpdatePPV1.aspx.vb"
    Inherits="EPG.UpdatePPV1" %>
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon alert-danger">24 hr format only
                                        ...
                                        <asp:MaskedEditValidator ID="MaskedEditValidator2" runat="server" ControlExtender="maskTime"
                                            ...
                                            EmptyValueMessage="Enter Time" ErrorMessage="Error time" InvalidValueMessage="Time invalid"
                        ...
                        <div class="row">
                            <asp:GridView ID="grdUpdatePPV" runat="server" AutoGenerateColumns="False" CssClass="table"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Filler Duration" SortExpression="FillerDuration" Visible="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Filler Duration" SortExpression="FillerDuration" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lbFillerD" runat="server" Text='<%# Bind("FillerDuration") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Movie Duration" SortExpression="MovieDuration" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lbMovieD" runat="server" Text='<%# Bind("MovieDuration") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddlChannelName" runat="server" CssClass="form-control" AutoCompleteMode="SuggestAppend"
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6">
                                <div class="form-group">
                                    <label>
                                        No. Of Days</label>
                                    <div class="input-group">
                                            <asp:TextBox ID="txtDays" runat="server" CssClass="form-control" ValidationGroup="days" CausesValidation="true" AutoPostBack="true" />
                                        ...
                                        <span class="input-group-addon">
                                            <asp:RegularExpressionValidator ID="REVtxtDays" runat="server" ControlToValidate="txtDays"
                                                    ValidationGroup="days" ForeColor="Red" Text="*Number"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <asp:GridView ID="grdXMLGenerated" runat="server" ShowHeader="False" CssClass="table"
                                            ...
                                            EmptyDataText="No Records to display" GridLines="Horizontal" 
