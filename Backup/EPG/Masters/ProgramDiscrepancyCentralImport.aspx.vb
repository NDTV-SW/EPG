...
Public Class ProgramDiscrepancyCentralImport
    ...
    Private Sub grdProgrammaster_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdProgrammaster.RowDataBound
        Try
            ...
            If e.Row.RowType = DataControlRowType.Header Then
                'lbCount.Text = "Total Records found : 0"
            ...
            If e.Row.RowType = DataControlRowType.Footer Then
                'lbCount.Text = "Total Records found : " & grdProgrammaster.Rows.Count
            End If
        Catch ex As Exception
    ...
    Private Sub exec_ProcRegional(ByVal ProgId As Integer, ByVal ProgName As String, ByVal synopsis As String, ByVal LanguageID As Integer, ByVal ID As Integer, ByVal action As Char, ByVal vEpisodeNo As Integer)
        ...
        Catch ex As Exception
            Logger.LogError("ProgramDiscrepancyCentralImport", action & " exec_ProcRegional", "Message:  Action='" & action & "', Progid='" & ProgId & "',ProgName='" & ProgName & "',Synopsis'""',LanguageId='" & LanguageID & "', RowId='" & ID.ToString & "', ActionUser='" & User.Identity.Name & "' ", User.Identity.Name)
            Logger.LogError("ProgramDiscrepancyCentralImport", action & " exec_ProcRegional", ex.Message.ToString, User.Identity.Name)
        End Try
    End Sub
    ...
    Private Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        ...
        If (FileUpload1.HasFile AndAlso (IO.Path.GetExtension(FileUpload1.FileName) = ".xlsx" Or IO.Path.GetExtension(FileUpload1.FileName) = ".xls")) Then
            Try
                ...
                End If
                'ExecImportPC()
                bindMeGrid()  'Bind Error wala grid that were not uploaded
                bindGrid()
