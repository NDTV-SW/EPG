...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <asp:GridView ID="grdInactive" runat="server" DataSourceID="sqlDSInactive" CssClass="table" AutoGenerateColumns="false"
                        EmptyDataText="No In-Active program found" Caption="Inactive programs for this Channel"
    ...
    ConnectionStrings:EPGConnectionString1 %>" SelectCommand="SELECT channelid from mst_channel where onair=1 and companyid<>28 order by 1">
    </asp:SqlDataSource>
