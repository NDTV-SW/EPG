            ...
            <div class="panel-body">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-right">
                            ...
                            <asp:TemplateField HeaderText="Select Parent Programme">
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddlParentProgram" runat="server" CssClass="form-control"
                                        DataSourceID="SqlDsProgram" DataTextField="progname" DataValueField="progid" />
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:SqlDataSource ID="SqlDsProgram" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                        SelectCommand="select '0' progid,' ---Select---' progname union select progid,progname from mst_program where progid = parent_progid and channelid=@channelid union  select progid,progname from mst_program where seriesenabled=1 and channelid=@channelid and progid in (select distinct progid from mst_epg where channelid=@channelid) order by 2">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtChannel" Name="ChannelId" PropertyName="Text"
                                Type="String" />
                        </SelectParameters>
