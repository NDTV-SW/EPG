<%@ Page Title="Program Central" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="ProgramCentralEdit.aspx.vb" Inherits="EPG.ProgramCentralEdit" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Table ID="Table1" runat="server" GridLines="both" BorderWidth="2" CellPadding="5"
        ...
        <asp:TableRow>
            <asp:TableCell HorizontalAlign="Left" VerticalAlign="Top" Width="50%">
                <h2>
                    Programme Central</h2>
                <asp:Table ID="tblProgramMaster" runat="server" GridLines="both" BorderWidth="2"
                     ...
                     Channel
                        ...
                        <asp:TableCell HorizontalAlign="Left">
                            ...
                            <asp:SqlDataSource ID="SqlDsChannelMaster" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlChannelOnair" Direction="Input" Name="onair"
                                        Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </asp:TableCell>
                    ...
                    Show All
                        ...
                        <asp:TableHeaderCell HorizontalAlign="Left">
                         ...
                         <asp:TableCell>
                            <asp:DropDownList ID="ddlLanguage" runat="server" DataSourceID="sqlDSLanguage" DataTextField="fullname"
                    ...
                    <asp:TableRow>
                        <asp:TableCell HorizontalAlign="Left" ColumnSpan="4">
                            ...
                            <asp:GridView ID="grdProgramCentral" runat="server" AutoGenerateColumns="False" EmptyDataRowStyle-BackColor="Red"
                                ...
                                DataSourceID="sqlDSProgramCentral" ForeColor="#333333" GridLines="Both" Width="100%"
                            ...
                            <asp:SqlDataSource ID="sqlDSProgramCentral" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                                ...
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlChannelName" Direction="Input" Name="ChannelId"
                                        Type="String" />
