...
Public Class UpdatePPV1
    ...
    Private Sub bindGrid()
        Dim adpBindPPV As New SqlDataAdapter("select * from mst_channel_ppv order by channelID asc", MyConnection)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Dim strFillerDuration As String, strMovieDuration As String
    ...
    Private Sub grdUpdatePPV_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdUpdatePPV.SelectedIndexChanged
        Try
            ...
            Try
                Dim strFillerDuration As String = Convert.ToDateTime(lbFillerDuration.Text).ToString("HH:mm:ss")
    ...
    Private Sub CreateXml()
        Dim ChannelId As String = ddlChannelName.SelectedValue.ToString
        ...
        strRecepient = "hemant@ndtv.com;kautilyar@ndtv.com"
        strSubject = "XML generated for " & ddlChannelName.Text.ToString.Trim & " from " & strStartDate & " to " & strEndDate & ""
        strBody = "Hi Team,<br/><br/>XML for <b>" & ddlChannelName.Text.ToString.Trim & "</b> has been generated from <b>" & strStartDate & "</b> to <b>" & strEndDate & "</b>.<br/><br/>"
