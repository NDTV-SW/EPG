<%@ Page Title="Program Central" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="ProgramCentralEditEpisodic.aspx.vb" Inherits="EPG.ProgramCentralEditEpisodic" MaintainScrollPositionOnPostback ="true" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <script type="text/javascript">
       ...
       function openWin(onair, progid, langid, controlid, index, episodeNo) {
           window.open("EditProgNameEpisodic.aspx?onair=" + onair + "&progid=" + progid + "&langid=" + langid + "&controlid=" + controlid + "&index=" + index + "&episodeNo=" + episodeNo, "Edit Programme", "width=650,height=330,toolbar=0,left=300,top=250,scrollbars=no,location=0,menubar=0,resizable=no,status=0");
       }
   ...
   <asp:Table ID="Table1" runat="server" GridLines="both" BorderWidth="2" CellPadding="5" CellSpacing="0"  Width="95%">
      <asp:TableRow>
         <asp:TableCell HorizontalAlign="Left" VerticalAlign="Top" Width="50%">
            <h2>Programme Central Episodic Shows</h2>
            <asp:Table ID="tblProgramMaster" runat="server" GridLines="both" BorderWidth="2" CellPadding="5" CellSpacing="0" Width="90%">
               <asp:TableRow>
                  <asp:TableHeaderCell HorizontalAlign="Right">
                     Select
                  </asp:TableHeaderCell>
                  <asp:TableCell>
                     <asp:ComboBox ID="ddlChannelOnair" runat="server" AutoCompleteMode="SuggestAppend"
                  ...
                  <asp:TableCell HorizontalAlign="Left">
                     ...
                     <asp:SqlDataSource ID="SqlDsChannelMaster" runat="server" 
                        ...
                        SelectCommand="SELECT ChannelId FROM mst_Channel where active=1 and Onair=@onair ORDER BY ChannelId">
                        <SelectParameters>
                           <asp:controlParameter ControlID="ddlChannelOnair" Direction="Input" Name="onair" Type="String" />
                        </SelectParameters>
                     </asp:SqlDataSource>
                  </asp:TableCell>
                  <asp:TableHeaderCell HorizontalAlign="Right">
            ...
            <asp:Table ID="tblProgramGrid" runat="server" GridLines="both" BorderWidth="2" CellPadding="5" CellSpacing="0">
               <asp:TableRow>
                  <asp:TableCell HorizontalAlign="Left" ColumnSpan="4">
                     <h3>
                        ALL PROGRAMMES FOR: <asp:Label ID="lbChannel" ForeColor="Red" runat="server" /><br />
                        SYNOPSIS NEEDED FOR: <asp:Label ID="lbSynopsisNeeded" ForeColor="Red" runat="server" />
                     </h3>
                     <br />
                     <b>Note:<br />
                     ...
                     3. Rows in WHITE are not part of EPG.</b><br />

                     <asp:GridView ID="grdProgramCentral" runat="server" AutoGenerateColumns="False" EmptyDataRowStyle-BackColor="Red" EmptyDataText="No record Found for this Channel"
                        CellPadding="4" DataKeyNames="Engprog" DataSourceID="sqlDSProgramCentral" 
                     ...
                     <asp:SqlDataSource ID="sqlDSProgramCentral" runat="server" 
                        ...
                        <SelectParameters>
                           <asp:controlParameter ControlID="ddlChannelName" Direction="Input" Name="ChannelId" Type="String" />
