        ...
        <div class="panel panel-default">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV_txtChannel" runat="server" ControlToValidate="txtChannel" Text="*" ForeColor="Red" ValidationGroup="RFGViewEPG" />
                                </span>
                            </div>
                        </div>
                        <br />
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <div class="form-group">
                            <label>
                                End Date</label>
                            <div class="input-group">
                                <asp:TextBox ID="txtEndDate" placeholder="Start Date" runat="server" CssClass="form-control"
                                    ValidationGroup="RFGViewEPG" />
                                <span class="input-group-addon">
            ...
            Duration (Mins)
                            ...
                            <asp:TableRow BackColor="#6B696B" ForeColor="White" Font-Size="Medium" Font-Bold="true"
                                ...
                                </asp:TableCell></asp:TableRow></asp:Table></div><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:GridView ID="grdViewEPG" runat="server" AutoGenerateColumns="False" CssClass="table"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Air Date" ItemStyle-VerticalAlign="Top" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lbprogdate" runat="server" Text='<%# Eval("progdate1") %>'></asp:Label></ItemTemplate><ControlStyle Width="100" />
                                    <ItemStyle VerticalAlign="Top"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="WeekDay" ItemStyle-VerticalAlign="Top" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lbWeekDay" runat="server" Text='<%# Eval("WeekDay") %>'></asp:Label></ItemTemplate><ControlStyle Width="60" />
                                    <ItemStyle VerticalAlign="Top"></ItemStyle>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Week" ItemStyle-VerticalAlign="Top" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lbWeekNumber" runat="server" Text='<%# Eval("WeekNumber") %>'></asp:Label></ItemTemplate><ControlStyle Width="10" />
                                    <ItemStyle VerticalAlign="Top"></ItemStyle>
                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="grdChildViewEpg" runat="server" AutoGenerateColumns="false" ShowHeader="true"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Prog ID" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbprogid" runat="server" Text='<%# Eval("progid") %>'></asp:Label></ItemTemplate><ControlStyle Width="60" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Program Name" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbprogname" runat="server" Text='<%# Eval("progname") %>'></asp:Label></ItemTemplate><ControlStyle Width="200" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Synopsis" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbSynopsis" runat="server" Text='<%# Eval("Synopsis") %>'></asp:Label></ItemTemplate><ControlStyle Width="300" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Genre" ItemStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbGenre" runat="server" Text='<%# Eval("GenreName") %>'></asp:Label></ItemTemplate><ControlStyle Width="100" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="AirTime" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbprogtime" runat="server" Text='<%# Eval("progtime") %>'></asp:Label></ItemTemplate><ControlStyle Width="100" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="GMT AirDate" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbprogDateGMT" runat="server" Text='<%# Eval("progtimeGMT") %>'></asp:Label></ItemTemplate><ControlStyle Width="100" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="GMT AirTime" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbprogtimeGMT" runat="server" Text='<%# Eval("progtimeGMT") %>'></asp:Label></ItemTemplate><ControlStyle Width="100" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Duration" ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbduration" runat="server" Text='<%# Eval("duration") %>'></asp:Label></ItemTemplate><ControlStyle Width="80" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Epi. No." ItemStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbEpisodeNo" runat="server" Text='<%# Eval("EpisodeNo") %>'></asp:Label></ItemTemplate><ControlStyle Width="60" />
                                                </asp:TemplateField>
                                            </Columns>
