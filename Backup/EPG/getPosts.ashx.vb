...
Public Class getPosts
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim sQuery As String = "select top 150 ErrorPage,ErrorSource,ErrorType,ErrorMessage,LoggedinUser,ErrorDateTime,convert (varchar,ErrorDateTime,100) ErrorDateTime1 from app_error_logs order by ErrorDateTime desc"
