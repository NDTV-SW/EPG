    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not (User.IsInRole("ADMIN") Or User.IsInRole("SUPERUSER")) Then
                If Not User.Identity.Name.ToLower.Contains("mverx") Then
        ...
        Try
            ...
            For Each row In GridView1.Rows
                ...
                If chkFTP.Checked Then
                    ...
                    obj.executeSQL("sp_aud_epg_xml_ftp", "channelid~startdate~enddate", "varchar~datetime~datetime", lbChannelID.Text & "~" & dtStartDate & "~" & dtEndDate, True, False)
