                    ...
                    If excelReader.AsDataSet.Tables(0).Rows.Count > 0 Then
                        For i = 0 To excelReader.AsDataSet.Tables(0).Rows.Count - 1
                            ...
                            If a >= DateTime.Now.AddDays(-1).Date Then
                                ...
                                Dim vTime As String
                                Try
                                    vTime = Convert.ToDateTime(Date.FromOADate(Convert.ToDouble(excelReader.AsDataSet.Tables(0).Rows(i).Item(3)).ToString)).ToShortTimeString
                                Catch
                                    vTime = Convert.ToDateTime(excelReader.AsDataSet.Tables(0).Rows(i).Item(3)).ToShortTimeString
                                End Try
