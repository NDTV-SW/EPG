...
Public Class ProcessTask
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim progname As String = Request.QueryString("progname")
        ...
        Try
            ...
            Dim boolInserted As Boolean = obj.Insert_mstProg(channelid, progname, genre, rating, 0, 1, IIf(episode = "", 0, episode), status, movie, "Process Task", User.Identity.Name)
