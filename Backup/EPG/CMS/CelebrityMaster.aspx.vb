        ...
        Try
            ...
            If btnUpdate.Text = "ADD" Then
                obj.executeSQL("sp_tmdb_celebrity", _
                               "tmdbCelebrityId~Name~placeofBirth~BirthDay~DeathDay~homepage~profilePath~adult~biography~verified~languageId~ActionUser~ActionType", _
                               "Int~NVarChar~VarChar~VarChar~VarChar~VarChar~VarChar~VarChar~NVarChar~Bit~Int~VarChar~Char", _
                               strRowId & "~" & strCelebrityName & "~" & strPlaceOfBirth & "~" & strBirthDay & "~" & strDeathDay & "~~~" & strAdult & "~" & strBiography & "~" & chkVerified.Checked & "~" & ddlCelebLanguage.SelectedValue & "~" & User.Identity.Name & "~A", _
                                True, False)
            Else
                obj.executeSQL("sp_tmdb_celebrity", _
                           "rowid~Name~placeofBirth~BirthDay~DeathDay~homepage~profilePath~adult~biography~verified~languageId~ActionUser~ActionType", _
                           "Int~NVarChar~VarChar~VarChar~VarChar~VarChar~VarChar~VarChar~NVarChar~Bit~Int~VarChar~Char", _
                           strRowId & "~" & strCelebrityName & "~" & strPlaceOfBirth & "~" & strBirthDay & "~" & strDeathDay & "~" & strHomePage & "~" & strProfilePath & "~" & strAdult & "~" & strBiography & "~" & chkVerified.Checked & "~" & ddlCelebLanguage.SelectedValue & "~" & User.Identity.Name & "~U", _
                            True, False)
            End If
            bindGrid(True, False)
        Catch ex As Exception
