<%@ Page Title="Notifications" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEPGBootStrap.Master"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <asp:RequiredFieldValidator ID="RFV_txtTitle" runat="server" ControlToValidate="txtTitle" Text="*" ForeColor="Red" />
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <asp:RequiredFieldValidator ID="RFV_txtBody" runat="server" ControlToValidate="txtBody" Text="*" ForeColor="Red" />
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <asp:RegularExpressionValidator ID="REV_txtURL" runat="server" ValidationExpression="^((http[s]?|ftp):\/)?\/?([^:\/\s]+)((\/\w+)*\/)([\w\-\.]+[^#?\s]+)(.*)?(#[\w\-]+)?$" ControlToValidate="txtURL" Text="*" ForeColor="Red" />
                                        <asp:RequiredFieldValidator ID="RFV_txtURL" runat="server" ControlToValidate="txtURL" Text="*" ForeColor="Red" />
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon">
                                        <asp:RequiredFieldValidator ID="RFV_txtKillTime" runat="server" ControlToValidate="txtKillTime" Text="*" ForeColor="Red" />
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtKeywords" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3" />
                                    <span class="input-group-addon">
                                        <asp:RequiredFieldValidator ID="REV_txtKeywords" runat="server" ControlToValidate="txtKeywords" Text="*" ForeColor="Red" />
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtGenreKeywords" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3" />
                                    <span class="input-group-addon">
                                        <asp:RequiredFieldValidator ID="RFVtxtGenreKeywords" runat="server" ControlToValidate="txtGenreKeywords" Text="*" ForeColor="Red" />
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtLangKeywords" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3" />
                                    <span class="input-group-addon">
                                        <asp:RequiredFieldValidator ID="RFVtxtLangKeywords" runat="server" ControlToValidate="txtLangKeywords" Text="*" ForeColor="Red" />
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Keywords" SortExpression="Keywords">
                                <ItemTemplate>
                                    ...
                                    <asp:Label runat="server" ID="lbGenreKeyword" Text='<%# Bind("GenreKeyword") %>' Visible="false" />
                                    <asp:Label runat="server" ID="lbLanguageKeyword" Text='<%# Bind("LanguageKeyword") %>' Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
