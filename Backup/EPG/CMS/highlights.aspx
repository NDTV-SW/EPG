                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:SqlDataSource ID="sqlDSDTHCableOperators" runat="server" ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>"
                                                SelectCommand="select operatorid,name from mst_dthcableoperators where active =1 and operatorid=125 order by 2">
                                            </asp:SqlDataSource>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <asp:GridView ID="grdHighLights" runat="server" AutoGenerateColumns="False" CssClass="table"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Vision Asia Date Time" SortExpression="istDate">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbVADate" Text='<%# Bind("vaDate") %>' />
                                            <asp:Label runat="server" ID="lbVATime" Text='<%# Bind("vaTime") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="FreshAirTime VA">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbFreshAirTimeVA" Text='<%# Bind("FreshAirTimeVA") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
