<%@ Page Title="Upload Excel" Language="vb" MasterPageFile="~/SiteBootStrap.Master"
    AutoEventWireup="false" CodeBehind="uploadExcel.aspx.vb" Inherits="EPG.uploadExcel" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="alert alert-danger">Note :Sample Excel to upload
                        <img src="../images/samplebigtv.jpg" alt="sample" width="100%" /></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
