            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:SqlDataSource ID="sqlDSddlProgramme" runat="server" SelectCommandType="Text"
                                        ConnectionString="<%$ ConnectionStrings:EPGConnectionString1 %>" SelectCommand="select 0 progid ,'Others' progname,0 priority union select progid,progname, 1 'priority' from mst_program where channelid=@channelid and ProgID in (select distinct ProgID from mst_epg where ProgDate>dbo.GetLocalDate()-5) order by 3 desc,2">
                                        <SelectParameters>
                        ...
                        <asp:CheckBox ID="chkCorrectOnAirtelDTH" runat="server" Checked="false" CssClass="form-control" Visible="false" />
                        <asp:CheckBox ID="chkCorrectOnTataSkyDTH" runat="server" Checked="false" CssClass="form-control" Visible="false" />
                ...
                <div class="panel-body">
                        ...
                        <asp:GridView ID="grdRelianceError" runat="server" GridLines="Vertical" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="EPG Program" SortExpression="ProgName">
                                    <ItemTemplate>
                                        <asp:Label ID="lbProgName" runat="server" Text='<%#Eval("ProgName") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="On-Air Program" SortExpression="actualRunningProgram">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Error Date" SortExpression="ErrorDateTime">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Status" SortExpression="AcceptedbyNDTV">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnUpdate" runat="server" CausesValidation="False" CommandName="update"
                                            ImageUrl="~/Images/blue.png" CommandArgument='<%# CType(Container, GridViewRow).RowIndex %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:SqlDataSource ID="sqlDSRelianceError" runat="server" SelectCommand="sp_error_display_bigTV"
                            ...
                            UpdateCommand="select dbo.GetLocalDate()">
                            <SelectParameters>
